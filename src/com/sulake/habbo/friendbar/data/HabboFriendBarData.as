package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_644:String = "Navigation";
      
      private static const const_645:String = "Friend Bar";
      
      private static const const_1391:String = "go.friendbar";
      
      private static const const_1389:String = "chat_btn_click";
      
      private static const const_1390:String = "find_friends_btn_click";
      
      private static const const_1010:String = "Toolbar";
      
      private static const const_1008:String = "open";
      
      private static const const_1009:String = "close";
      
      private static const const_1392:String = "FRIENDLIST";
      
      private static const const_1388:String = "MESSENGER";
       
      
      private var var_87:IHabboCommunicationManager;
      
      private var var_294:IHabboFriendList;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_294)
            {
               this.var_294.release(new IIDHabboFriendList());
               this.var_294 = null;
            }
            if(this.var_424)
            {
      ...
      {
         return this.var_293.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_644,const_645,const_1391));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_424)
         {
            ...
            if(this.var_87)
            {
               this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_644,const_645,const_1389));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_644,const_645,const_1390));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_294)
         {
            if(!this.var_294.disposed)
            {
               if(!this.var_294.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_294.openFriendRequests();
                  }
                  else
                  {
                     this.var_294.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_294.mainWindow;
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1010,const_1392,!!this.var_294.isOpen() ? const_1008 : const_1009));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_424)
         {
            if(!this.var_424.disposed)
            {
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1010,const_1388,!!this.var_424.isOpen() ? const_1008 : const_1009));
               }
            }
         }
      }
      ...
      {
         this.var_294 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_293.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_293.remove(_loc8_);
               this.var_135.splice(this.var_135.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_293.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_298)
            {
               ...
               this.var_293.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_298)
            {
               if(this.var_293.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
                  this.var_135.push(_loc3_);
                  this.var_293.add(_loc3_.id,_loc3_);
         ...
         {
            this.var_135 = !!const_298 ? this.sortByNameAndOnlineStatus(this.var_135) : this.sortByName(this.var_135);
         }
