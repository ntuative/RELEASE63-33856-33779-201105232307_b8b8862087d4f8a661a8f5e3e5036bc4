package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1981:String = "title";
      
      private static const BUTTON:String = "button";
      
      private static const const_1607:String = "addFriendsTabXML";
      
      private static const const_1608:String = "add_friends_icon_png";
      
      private static var var_1070:int = -1;
      
      private static const const_67:uint = 6907230;
      ...
      {
         var _loc1_:IWindowContainer = false ? const_449.pop() : var_1339.buildFromXML(var_871.getAssetByName(const_1607).content as XML) as IWindowContainer;
         var _loc2_:IRegionWindow = IRegionWindow(_loc1_.findChildByName(const_643));
         ...
         if(var_1070 < 0)
         {
            var_1070 = _loc1_.height;
         }
         _loc1_.height = name_1;
         var _loc3_:IBitmapWrapperWindow = _loc1_.findChildByName(const_1051) as IBitmapWrapperWindow;
         _loc3_.disposesBitmap = false;
         _loc3_.bitmap = var_871.getAssetByName(const_1608).content as BitmapData;
