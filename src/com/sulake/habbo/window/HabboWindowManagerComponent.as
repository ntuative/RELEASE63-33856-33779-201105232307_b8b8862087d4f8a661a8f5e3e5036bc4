package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1429:uint = 1;
      ...
      private var var_973:IWindowRenderer;
      ...
      private var var_1833:ProfilerOutput;
      
      private var var_1468:ProfilerAgentTask;
      
      private var var_1470:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_973 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_452);
         ...
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_973,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_278 = this._windowContextArray[const_1429];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1833)
            {
               this.var_1833 = new ProfilerOutput(context,this,this.var_973);
            }
            this.var_1833.profiler = _loc3_;
            ...
            this.var_1470 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1470);
            this.var_1222 = true;
         }
      }
      ...
      {
         return this.var_278.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_278.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_278.getDesktopWindow().numChildren - 1);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1750,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1777,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1652,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1730,param2.name + ": " + param2.toString());
            }
         }
      }
