package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      protected static const const_1926:String = "_alert_button_list";
      
      protected static const const_553:String = "_alert_button_ok";
      
      protected static const const_989:String = "_alert_button_cancel";
      
      protected static const const_1333:String = "_alert_button_custom";
      
      protected static const const_1340:String = "header_button_close";
      
      protected static const const_1778:String = "_alert_text_summary";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = this._window.findChildByName(const_1926) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_553);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
            ...
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_1333);
               _loc8_.dispose();
            }
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case const_1340:
                  if(this.var_284 != null)
                  {
                     _loc3_ = WindowEvent.allocate(WindowEvent.const_558,null,null);
                     this.var_284(this,_loc3_);
                     _loc3_.recycle();
                  }
                  else
      ...
      public function getButtonCaption(param1:int) : ICaption
      {
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_553:
                  _loc2_ = this._window.findChildByName(const_553) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_989:
                  _loc2_ = this._window.findChildByName(const_989) as IInteractiveWindow;
                  break;
               case HabboAlertDialogFlag.const_1333:
                  _loc2_ = this._window.findChildByName(const_1333) as IInteractiveWindow;
            }
         }
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(this._window)
         {
            ITextWindow(this._window.findChildByTag("DESCRIPTION")).text = this.var_2069;
         }
      }
