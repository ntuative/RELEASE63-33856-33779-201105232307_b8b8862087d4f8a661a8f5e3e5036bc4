package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_908.indexOf(param1) < 0)
         {
            this.var_908.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1126.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_908.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_908.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1126.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1126.getValue(param1) == null)
         {
            this.var_1126.add(param1,true);
