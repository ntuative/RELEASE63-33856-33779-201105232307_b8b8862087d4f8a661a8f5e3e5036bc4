package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1467:uint = 16777215;
      
      private var var_1826:int = 255;
      
      private var var_1215:uint = 16777215;
      
      private var var_1825:int = 255;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_590,RoomObjectMouseEvent.const_136];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1258,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_748,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_976,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_779,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_684,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1214)
         {
            ...
            if(_loc2_ - this.var_1214 >= this.var_1823)
            {
               _loc3_ = this.var_1215;
               _loc4_ = this.var_1825;
               this.var_1214 = 0;
            }
            else
            {
               _loc7_ = this.var_1467 >> 16 & 255;
               _loc8_ = this.var_1467 >> 8 & 255;
               _loc9_ = this.var_1467 & 255;
               _loc10_ = this.var_1215 >> 16 & 255;
               _loc11_ = this.var_1215 >> 8 & 255;
               _loc12_ = this.var_1215 & 255;
               _loc13_ = (_loc2_ - this.var_1214) / this.var_1823;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1826 + (this.var_1825 - this.var_1826) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_748,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_483:
               ...
               this.var_517.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_819:
               _loc4_ = this.var_517.method_9(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_517.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1226:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1223:
               param2.setNumber(RoomObjectVariableEnum.const_779,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_684,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_641:
               param2.setNumber(RoomObjectVariableEnum.const_1304,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1162:
               param2.setNumber(RoomObjectVariableEnum.const_1119,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1132,int(param1.bgOnly));
         this.var_1467 = this._color;
         this.var_1826 = this.var_1824;
         this.var_1215 = _loc3_;
         this.var_1825 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_599,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1646,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1698,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1762,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_599,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_268 || _loc12_ == RoomPlaneData.const_386)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
