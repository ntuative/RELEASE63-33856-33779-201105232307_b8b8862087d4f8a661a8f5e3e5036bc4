package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_158,RoomObjectFurnitureActionEvent.const_594];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(object != null)
         {
            object.getModelController().setString(RoomObjectVariableEnum.const_1112,"");
         }
      }
      ...
      protected function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_238,_loc3_ + 1);
         }
      }
