package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_2209:String = "TYPE_INJECTED";
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_164,RoomObjectFurnitureActionEvent.const_485];
      ...
      override public function useObject() : void
      {
         ...
         if(eventDispatcher != null && object != null)
         {
            ...
            _loc3_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_485,_loc1_,_loc2_);
