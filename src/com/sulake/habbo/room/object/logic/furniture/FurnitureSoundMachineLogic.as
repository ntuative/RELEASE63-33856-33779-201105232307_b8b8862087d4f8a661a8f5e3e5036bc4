package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_616,RoomObjectFurnitureActionEvent.const_625,RoomObjectFurnitureActionEvent.const_486,RoomObjectFurnitureActionEvent.const_542];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2209)
         {
            this.var_2209 = _loc3_;
            if(_loc3_ == 1)
            {
      ...
      private function requestStopPlaying() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_625,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
