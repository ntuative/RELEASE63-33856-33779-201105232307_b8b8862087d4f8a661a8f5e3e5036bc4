   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_734 != _loc2_)
         {
            ...
            if(_loc3_ * const_460 > const_1011)
            {
               this.var_932 = const_1011 / _loc3_;
            }
            else
            {
               this.var_932 = const_460;
            }
            this.var_1417 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_734 && param1 >= this.var_1417 + this.var_932)
            {
               _loc3_ = param1 - this.var_1417;
               _loc4_ = _loc3_ / this.var_932;
               _loc5_ = 1;
               if(this.var_734 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1417 = param1 - (_loc3_ - _loc4_ * this.var_932);
            }
         }
      }
   }
