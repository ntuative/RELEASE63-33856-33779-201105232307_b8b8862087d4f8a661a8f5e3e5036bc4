package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_497,RoomObjectFurnitureActionEvent.const_574,RoomObjectFurnitureActionEvent.const_552,RoomObjectFurnitureActionEvent.const_517,RoomObjectWidgetRequestEvent.const_142];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_416,RoomWidgetInfostandExtraParamEnum.const_543);
            ...
            if(_loc4_ != this.var_2209)
            {
               this.var_2209 = _loc4_;
               if(_loc4_ == 1)
               {
