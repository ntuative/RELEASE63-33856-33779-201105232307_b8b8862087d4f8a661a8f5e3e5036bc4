package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1434:int = 360;
      
      private var var_742:DirectionData = null;
      
      private var var_250:Map;
      
      private var _colors:Map;
      
      private var var_1157:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_742 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_250 != null)
         {
            ...
            {
               _loc2_ = this.var_250.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_742,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_250.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_742);
            this.defineDirection(_loc3_,_loc8_);
            this.var_250.add(String(_loc7_),_loc3_);
            this.var_1738 = -1;
            this.var_1157 = null;
            _loc5_++;
         }
         ...
         while(_loc4_ < param2.length())
         {
            ...
            switch(_loc8_)
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1329);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1434 / 2) % 360 / this.var_1434;
         if(this.var_250.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_250.getKey(_loc5_)) * this.var_1434;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_250.getKey(_loc4_));
         }
         return const_1876;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_250.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_742;
         }
         this.var_1738 = param1;
         this.var_1157 = _loc2_;
         return this.var_1157;
      }
