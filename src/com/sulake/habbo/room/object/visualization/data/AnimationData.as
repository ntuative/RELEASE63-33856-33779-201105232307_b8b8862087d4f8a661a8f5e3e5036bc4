   ...
   public class AnimationData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_117 != null)
         {
            ...
            {
               _loc2_ = this.var_117.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         if(this.var_1592 != null && this.var_1592.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_474;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_117.add(param1,_loc6_);
         var _loc10_:int = _loc6_.frameCount;
         if(_loc10_ > this.var_474)
         {
            this.var_474 = _loc10_;
         }
         return true;
      }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_117.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_117.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
