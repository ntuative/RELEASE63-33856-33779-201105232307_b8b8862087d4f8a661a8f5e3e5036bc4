package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1629:int = 13421772;
      
      private static const const_1047:int = 16777215;
      
      private static const const_1048:int = 13421772;
      
      private static const const_1046:int = 10066329;
      
      private static const const_1045:int = 10066329;
      
      public static const const_1721:int = 16777215;
      
      public static const const_1622:int = 13421772;
      
      public static const const_1674:int = 10066329;
      ...
      private var var_762:Rectangle = null;
      
      private var var_517:RoomPlaneBitmapMaskParser = null;
      
      private var var_1390:String = null;
      
      private var _floorType:String = null;
      
      private var var_1391:String = null;
      
      private var _floorThicknessMultiplier:Number = NaN;
      
      private var var_1410:Number = NaN;
      
      private var var_1847:String = null;
      
      private var var_1225:uint = 16777215;
      
      private var var_2541:int = 255;
      
      private var var_2537:int = 255;
      
      private var var_2539:int = 255;
      
      private var var_1845:Boolean = true;
      
      private var var_1224:int = 0;
      
      private var var_1734:int = -1000;
      
      private const const_2220:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_517 = new RoomPlaneBitmapMaskParser();
         this.var_301["null"] = false;
         this.var_301["null"] = true;
         this.var_301["null"] = true;
         this.var_301["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_762 = super.boundingRectangle;
         }
         return new Rectangle(this.var_762.x,this.var_762.y,this.var_762.width,this.var_762.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_74 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
               ...
               if(_loc3_.type == RoomPlane.const_74)
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1410))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1410;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1258);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1127);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_240)
            {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_74,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_386)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1721;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1622;
               }
               else
               {
                  _loc13_.color = const_1674;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1854)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_74,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_386)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1734 + this.const_2220 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_368.length)
            {
               _loc11_ = this.var_624[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_368[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1845)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2539 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2537 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2541 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1711)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1514 || _loc3_.y != this.var_2538 || _loc3_.z != this.var_2540 || param1.scale != this.var_1846))
            {
               this.var_1514 = _loc3_.x;
               this.var_2538 = _loc3_.y;
               this.var_2540 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_1847)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1847 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_748));
            if(_loc4_ != this.var_1225)
            {
               this.var_1225 = _loc4_;
               this.var_2539 = this.var_1225 & 255;
               this.var_2537 = this.var_1225 >> 8 & 255;
               this.var_2541 = this.var_1225 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1132));
            if(_loc5_ != this.var_1845)
            {
               this.var_1845 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_201);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_206);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_205);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_976));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_779));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_684));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_150 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1119);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1410))
            {
               this._floorThicknessMultiplier = _loc2_;
               this.var_1410 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_140.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_74 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_301["null"] || param2 != this.var_301["null"] || param3 != this.var_301["null"])
         {
            this.var_301["null"] = param1;
            this.var_301["null"] = param2;
            this.var_301["null"] = param3;
            this.var_368 = [];
            this.var_624 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_368;
         if(this.var_368.length == 0)
         {
            _loc6_ = this.var_140;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_368.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_301[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1224;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_517.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_517.maskCount)
         {
            _loc10_ = this.var_517.getMaskType(_loc8_);
            _loc11_ = this.var_517.getMaskLocation(_loc8_);
            _loc12_ = this.var_517.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_140.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_74 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_74 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_232)
                              {
