package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_760:IGraphicAssetCollection;
      
      private var var_1780:XMLList;
      
      private var _offsetX:int;
      
      private var var_1194:int;
      
      private var var_2798:Vector3d;
      ...
      private var var_1044:Boolean = true;
      ...
      private var var_1565:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_1043)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1565 = this.var_44.getValue(this.var_1043);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2798 = new Vector3d(-0.5,0.5,0);
         this.var_1044 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2798);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_44.getValue(this.var_1043);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1997 = RoomObjectVariableEnum.const_1168;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1997 = RoomObjectVariableEnum.const_1137;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_44.getValue(this.var_1043);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2797 && param3 == this.var_2796)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1997);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1565.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_760.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_467.indexOf(_loc10_) >= 0 && this.var_1044)
            {
               param1 = this.var_467.indexOf(_loc10_);
               if(this.var_669[param1] != "")
               {
                  _loc9_ = this.var_760.getAsset(this.var_669[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
      ...
      {
         this.var_1044 = true;
         var _loc3_:int = this.var_467.indexOf(param1);
         if(_loc3_ < 0)
         {
