package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1755:int = const_387;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2226 = param6;
         this.var_2225 = param7;
         if(this.var_1674 == const_930)
         {
            this.var_1673 = false;
         }
      }
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.width == param2 && this.var_31.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_585,param6,param7);
                     return param1;
                  }
                  return this.var_31;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_31.width,this.var_585);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_31.height - this.var_585,this.var_31.width,this.var_585);
         }
