package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      {
         if(this.var_2250 == param1 || this.var_91 == null)
         {
            return;
         }
         this.var_91.copyPixels(this._copy,this._copy.rect,new Point(0,0));
         ...
         this.var_91.draw(_loc3_,_loc4_);
      }
   }
}
