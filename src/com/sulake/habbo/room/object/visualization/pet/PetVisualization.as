package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_674:PetVisualizationData = null;
      ...
      private const const_2245:int = 3;
      ...
      private const const_1530:int = 3;
      ...
      private var var_2011:Number = NaN;
      ...
      {
         this.var_674 = param1 as PetVisualizationData;
         createSprites(this.const_1530);
         var _loc2_:BitmapData = (this.var_674.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_365 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_2005 = param1.getNumber(RoomObjectVariableEnum.const_375) > 0;
            this.var_1572 = param1.getString(RoomObjectVariableEnum.const_160);
            this.var_276 = param1.getString(RoomObjectVariableEnum.const_295);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_840);
            this.var_2011 = param1.getNumber(RoomObjectVariableEnum.const_220);
            this.var_1461 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2236 = param1.getNumber(RoomObjectVariableEnum.const_957);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_219);
            if(this.var_696 != _loc3_)
            {
               this.var_696 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_480 != param1.getUpdateID() || this.var_1711 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_2011;
            if(isNaN(this.var_2011))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_2007 || param3)
            {
               this.var_2007 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_61.setDirectionAngle(AvatarSetType.const_35,_loc4_);
            }
            if(_loc5_ != this.var_2009 || param3)
            {
               this.var_2009 = _loc5_;
               _loc5_ -= 112.5;
               _loc5_ = (_loc5_ + 360) % 360;
               this.var_61.setDirectionAngle(AvatarSetType.const_53,_loc5_);
            }
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_674.getAvatar(this.var_696,param1,this);
            if(_loc3_ != null)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_92 || this.var_61 == null)
         {
            if(_loc7_ != var_92)
            {
               var_92 = _loc7_;
         ...
         var _loc12_:Boolean = this.var_990 || this.var_1308 > 0 || this.var_2034;
         this.var_365.alpha = 0;
         if(this.var_1461 > 0)
         {
            _loc13_ = param2 - this.var_1461;
            if(_loc13_ < AvatarAction.const_1039)
            {
               this.var_365.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_365.setExperience(this.var_2236);
               this.var_1308 = this.const_2245;
            }
            else
            {
               this.var_1461 = 0;
            }
            _loc14_ = getSprite(this.const_1973);
            if(_loc14_ != null)
            {
               if(this.var_365.alpha > 0)
               {
                  _loc14_.asset = this.var_365.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_365.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1081);
            if(_loc14_)
            {
               _loc19_ = this.var_61.getImage(AvatarSetType.const_35,false);
               if(_loc19_ != null)
               {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1572 != null && this.var_1572 != "")
         {
            param1.appendAction(AvatarAction.const_314,this.var_1572);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1530;
