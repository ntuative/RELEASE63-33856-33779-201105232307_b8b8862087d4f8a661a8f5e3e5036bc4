package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1424:String = "head";
      
      private static const const_653:int = 1;
      
      private static const const_1039:int = 1000;
      
      private static const const_1423:String = "pet_experience_bubble_png";
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_958 = [];
         super();
         while(this.var_121.length < ANIMATION_INDEX_COUNT)
         {
            this.var_121.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_121 != null)
         {
            ...
            {
               _loc2_ = this.var_121[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1423) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_365 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2489)
            {
               this.var_2489 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_150)
         {
            ...
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_160);
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_160);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2005 = _loc3_.getNumber(RoomObjectVariableEnum.const_375) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_220);
            if(!isNaN(_loc8_))
            {
               this.var_1813 = _loc8_;
            }
            else
            {
               this.var_1813 = direction;
            }
            this.var_1461 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2236 = _loc3_.getNumber(RoomObjectVariableEnum.const_957);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_953);
            if(_loc9_ != this.var_1812)
            {
               this.var_1812 = _loc9_;
               this.var_2490 = this.var_1812.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         {
            this.var_365.alpha = 0;
            if(this.var_1461 > 0)
            {
               _loc2_ = param1 - this.var_1461;
               if(_loc2_ < const_1039)
               {
                  this.var_365.alpha = int(Math.sin(_loc2_ / const_1039 * 0) * 255);
                  this.var_365.setExperience(this.var_2236);
               }
               else
               {
                  this.var_1461 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_365.alpha > 0)
                  {
                     _loc3_.asset = this.var_365.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_365.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_653;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_121.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1460 = false;
         var _loc1_:int = this.var_121.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_121[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_121.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_121[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_121.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_121[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2490);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_653)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_653))
            {
               if(param2 >= FurnitureVisualizationData.const_480.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_480[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1813);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_92,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1424)
            {
