   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_630.add(_loc6_,_loc7_);
         ...
         if(this.var_630.getValue(this.var_775) == null)
         {
            return false;
         }
         return true;
      ...
      {
         if(this.var_630.getValue(param1) == null)
         {
            param1 = this.var_775;
         }
         return int(this.var_630.getValue(param1));
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_630.length)
         {
            return this.var_630.getKey(param1);
         }
         return this.var_775;
      }
