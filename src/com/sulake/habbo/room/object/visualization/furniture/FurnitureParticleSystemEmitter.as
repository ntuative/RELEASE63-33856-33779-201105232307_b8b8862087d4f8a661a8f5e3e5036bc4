package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1706:String = "cone";
      
      public static const const_1834:String = "plane";
      
      public static const const_1859:String = "sphere";
      ...
      private var var_935:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_936 = 0;
         this.var_1059 = false;
         this.init(0,0,0,this._direction,this.var_2375,this.var_935,this.var_2372,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1170.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1059 = true;
         if(this.var_936 < this.var_1437)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2374)
         {
            switch(this.var_2373)
            {
               case const_1706:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_935,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_358.push(_loc4_);
            ++this.var_936;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1170.length);
         return this.var_1170[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_936 < this.var_1437)
         {
            if(this.age % this.var_2371 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_936 < this.var_1437)
         {
            ...
            this.y = (2 - this.var_252) * this.y - (1 - this.var_252) * this.lastY + this.var_1747 * this.var_935 * this.var_935;
         ...
         for each(_loc2_ in this.var_358)
         {
            ...
            _loc2_.y = (2 - this.var_252) * _loc2_.y - (1 - this.var_252) * _loc2_.lastY + this.var_1747 * this.var_935 * this.var_935;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_358.splice(this.var_358.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
