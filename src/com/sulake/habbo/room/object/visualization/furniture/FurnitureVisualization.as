package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1933:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2839:Number = NaN;
      
      private var var_2840:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1311:String = null;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1583 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1583;
            this.var_1583 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_583 != spriteCount)
         {
            createSprites(this.var_583);
         }
         if(param2)
         {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               if(param2 != this.var_1584)
               {
                  ...
                  _loc4_.color = this.getSpriteColor(param1,param2,this.var_2840);
               ...
               _loc4_.clickHandling = this.var_2510;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_480 != _loc3_.getUpdateID() || param1 != var_92 || param2 != this.var_2839)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2840 = _loc3_.getNumber(RoomObjectVariableEnum.const_238);
            ...
            this.var_1311 = this.getAdClickUrl(_loc3_);
            if(this.var_1311 == null || this.var_1311.indexOf("http") != 0)
            {
               this.var_1311 = null;
            }
            this.var_2510 = this.var_1311 != null;
            this.var_2841 = _loc3_.getNumber(RoomObjectVariableEnum.const_808);
      ...
      {
         if(this.var_2842 != param2 || this.var_2838 != param1)
         {
            this.var_1056 = [];
            this.var_1055 = [];
            this.var_833 = [];
            ...
            this.var_2843 = this.getSize(param1);
      ...
      {
         this.var_583 = param1;
         this.var_1584 = this.var_583 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_480.length)
         {
            return "";
         }
         ...
         {
            _loc5_ = this.var_2843;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1584)
            {
               _loc6_ = FurnitureVisualizationData.const_480[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_837[param3] != null && !this.var_2040)
         {
      ...
      {
         if(this.var_832[param2] != null)
         {
            return this.var_832[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2841 * (param1 / 2));
      }
