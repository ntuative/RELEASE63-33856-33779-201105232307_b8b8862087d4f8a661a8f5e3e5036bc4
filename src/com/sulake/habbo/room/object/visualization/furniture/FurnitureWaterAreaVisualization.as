package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1478:String = "shore";
      ...
      {
         if(this.var_2563 == param1 && this.var_2562 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1478)
            {
               this.var_1875 = _loc2_;
               this.var_2563 = param1;
               this.var_2562 = direction;
               return this.var_1875;
            }
            _loc2_--;
         }
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_629[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_629[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_522 == 0 || this.var_628 == 0)
         {
            ...
            this.var_522 = _loc2_.getNumber(RoomObjectVariableEnum.const_347);
            this.var_628 = _loc2_.getNumber(RoomObjectVariableEnum.const_424);
         }
         this.var_444 = [];
         this.var_629 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_522 * 2 + this.var_628 * 2)
         {
            this.var_444.push(false);
            this.var_629.push(ShoreMaskCreatorUtility.const_78);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_444,this.var_629,assetCollection);
      }
