package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1276:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_185:IHabboHelp;
      ...
      private var var_455:FramerateTracker = null;
      
      private var var_273:LatencyTracker = null;
      
      private var var_658:LagWarningLogger = null;
      
      private var var_456:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_455 = new FramerateTracker();
         this.var_273 = new LatencyTracker();
         this.var_658 = new LagWarningLogger();
         this.var_456 = new ToolbarClickTracker(this);
         this.var_1535 = new Array(const_1063);
         var _loc4_:int = 0;
         while(_loc4_ < const_1063)
         {
            this.var_1535[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1754,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1892,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1789,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_878,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1205,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1276)
            {
               this.var_1276.release(new IIDHabboWindowManager());
               this.var_1276 = null;
            }
            if(this.var_302)
            {
            ...
            if(this.var_206)
            {
               if(!this.var_206.disposed)
               {
                  ...
                  Component(this.var_206).events.removeEventListener(HabboFriendListTrackingEvent.const_468,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_185)
            {
               ...
               {
                  this.var_185.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_185.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_185.release(new IIDHabboHelp());
               this.var_185 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_210,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_344,this.onRoomAction);
            ...
            {
               this.var_315.stop();
               this.var_315.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_315 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_188)
         {
            if(this.var_273 != null)
            {
               this.var_273.configuration = this.var_188;
            }
            if(this.var_272 != null)
            {
               this.var_272.configuration = this.var_188;
            }
            ...
            if(this.var_188)
            {
               ...
               {
                  this.var_658.configure(this.var_188);
               }
               if(this.var_455 != null)
               {
                  this.var_455.configure(this.var_188);
               }
               if(this.var_456 != null)
               {
                  this.var_456.configure(this.var_188);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_821,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_286,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_498,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_658 != null)
            {
               this.var_658.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1839);
         }
         else if(param1.type == HabboHotelViewEvent.const_70)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1745);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_821:
               this.trackLoginStep(HabboLoginTrackingStep.const_1727,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_286:
               this.trackLoginStep(HabboLoginTrackingStep.const_286);
               break;
      ...
      {
         this.var_1276 = IHabboWindowManager(param2);
         if(this.var_1276)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_188)
            {
               if(this.var_188.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1535)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1308);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1308,this.onCoreRunning);
         }
      }
      ...
      private function onAchievementNotification(param1:HabboAchievementNotificationMessageEvent) : void
      {
         ...
         this.legacyTrack("achievement","achievement",[_loc2_.badgeCode]);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_206).events.addEventListener(HabboFriendListTrackingEvent.const_468,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_468:
      ...
      {
         this.var_185 = param2 as IHabboHelp;
         this.var_185.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_185.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2684)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1833);
            this.var_2684 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1205,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_878,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_210,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_344,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_302.events.addEventListener(AdEvent.const_602,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_344)
         {
            if(this.var_1941 < 1)
            {
               if(!this.var_315)
               {
                  this.var_315 = new Timer(60000,1);
                  this.var_315.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_315.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_328)
         {
            if(this.var_315)
            {
               this.var_315.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_455)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_455.frameRate),_loc2_);
                  ++this.var_1941;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_456)
         {
            this.var_456.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_456)
         {
            this.var_456.track(param1.type);
         }
      }
      ...
      {
         this.var_658.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_538 > -1 && _loc2_ < this.var_538)
         {
            ++this.var_1942;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1942);
         }
         if(this.var_538 > -1 && _loc2_ - this.var_538 > 15000)
         {
            ++this.var_1940;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1940);
         }
         this.var_538 = _loc2_;
         if(this.var_272 != null)
         {
            this.var_272.update(param1,this.var_538);
         }
         if(this.var_273 != null)
         {
            this.var_273.update(param1,this.var_538);
         }
         if(this.var_455 != null)
         {
            this.var_455.trackUpdate(param1,this,this.var_538);
         }
         if(this.var_658 != null)
         {
            this.var_658.update(this.var_538);
         }
      }
   }
}
