package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private var var_1178:Map;
      
      private var var_888:Map;
      
      private var var_1101:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1644 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1644 = 15;
         }
         this.var_1645 = this._window.height;
         this.var_1377 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      {
         if(param1.badgeId != this.var_230.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_604:
               ...
               _loc2_ = Number(this.var_1101) / Number(this.var_888["time_fade_in"]);
               if(this.var_1101 > int(this.var_888["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_994:
               ...
               if(this.var_1378 > int(this.var_888["time_display"]) && !this.var_1646)
               {
                  this.startFadeOut();
               }
               break;
            case const_993:
               ...
               _loc3_ = 1 - Number(this.var_1100) / Number(this.var_888["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1100 > int(this.var_888["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1644;
         if(this._window.height < this.var_1645)
         {
            this._window.height = this.var_1645;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1733;
         this._window.y = this.var_1377;
      }
