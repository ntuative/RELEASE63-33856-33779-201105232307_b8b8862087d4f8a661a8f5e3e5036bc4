package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1368:String = "pixelbalance";
      
      private static const const_1364:String = "badges";
      
      private static const const_1367:String = "selectbadge";
      
      private static const const_1369:String = "inventory";
      
      private static const const_1370:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1366:String = "friendlist";
      
      private static const const_1363:String = "pet_inventory";
      
      private static const const_1365:String = "go_to_room";
      ...
      private var var_345:HabboNotificationViewManager;
      
      private var var_221:HabboAlertDialogManager;
      
      private var var_715:ParkBusDialogManager;
      
      private var var_2218:Boolean;
      
      private var var_893:ClubGiftNotification;
      
      private var var_891:ClubEndingNotification;
      
      private var var_892:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_894);
         }
         var _loc6_:Map = this.var_894["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_894["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_345)
         {
            this.var_345.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1384[_loc3_.badgeCode] = new AchievementNotification(_loc3_.badgeCode,_loc3_.achievementID,_loc3_.level,_loc3_.points,_loc3_.levelRewardPoints,_loc3_.levelRewardPointType,_loc3_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_376);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1384[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1384[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      {
         this.var_345 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_894["styles"],this.var_894["view"]);
         ...
         registerUpdateReceiver(this.var_345,1);
         registerUpdateReceiver(this,2);
         this.var_376.events.addEventListener(BadgeImageReadyEvent.const_112,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_376.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1325,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1325,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1831,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_829,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_554.createAvatarImage(param2,AvatarScaleType.const_57);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_376.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_376.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_376.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1776,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1181)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1797,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1813)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_891 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_892 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_345.isSpaceAvailable() && this.var_1109.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_345.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1364:
               if(this.var_13 != null)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_262);
               }
               break;
            case const_1367:
               break;
            ...
            case const_1363:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_132);
               }
               break;
            case const_1370:
               break;
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_345.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_304;
            }
            if(param2 == 4057)
            {
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_715 == null)
         {
            this.var_715 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_715 != null)
         {
            this.var_715.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1144,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1144,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_554.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_57);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2218)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_829,null);
            this.var_2218 = true;
      ...
      {
         if(param2.type == WindowEvent.const_179 || param2.type == WindowEvent.const_558)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_893 && this.var_893.visible)
         {
            return;
         }
         this.var_893 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_829,_loc6_);
      }
   }
}
