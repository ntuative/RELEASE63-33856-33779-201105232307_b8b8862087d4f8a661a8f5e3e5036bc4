package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_1414:int = 78;
      
      private static const const_654:int = 4;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_1178,this.var_888,param1);
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < this.var_183.length)
         {
            ...
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_633 + const_654;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1448 = const_1414 + param1;
         var _loc2_:int = this.var_1448;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_183.length)
         {
            _loc4_ = this.var_183[_loc3_] as HabboNotificationItemView;
            _loc4_.reposition(_loc2_);
            _loc2_ = _loc4_.verticalPosition + HabboNotificationItemView.const_633 + const_654;
            _loc3_++;
         }
      }
   }
