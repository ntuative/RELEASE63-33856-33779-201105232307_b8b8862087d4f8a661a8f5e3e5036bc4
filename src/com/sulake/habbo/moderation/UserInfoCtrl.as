package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1034:int = 60;
      
      private static const const_1031:int = 3600;
      
      private static const const_1032:int = 86400;
      
      private static const const_1033:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1034)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1031)
         {
            return Math.round(param1 / const_1034) + " mins ago";
         }
         if(param1 < 2 * const_1032)
         {
            return Math.round(param1 / const_1031) + " hours ago";
         }
         if(param1 < 2 * const_1033)
         {
            return Math.round(param1 / const_1032) + " days ago";
         }
         return Math.round(param1 / const_1033) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1113,this._data.userId),this._callerFrame,this.var_1181,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1466),this._callerFrame,this.var_1181,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1466),this._callerFrame,this.var_1181,false,true);
      }
