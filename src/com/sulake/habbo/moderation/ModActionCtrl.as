package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1212:IDropMenuWindow;
      ...
      private var var_968:OffenceCategoryData;
      
      private var var_969:OffenceData;
      
      private var var_1211:IButtonWindow;
      
      private var var_1213:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1211 = IButtonWindow(this.var_34.getXmlWindow("modact_offence"));
         this.var_1213 = IButtonWindow(this.var_34.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1822;
         ...
         this.var_1212 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1212);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_968 != null;
         if(this.var_969 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_969.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_968 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_968.offences,this.var_1211,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_34.initMsg.offenceCategories,this.var_1213,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1908;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModAlertMessageComposer(this.var_1465,this.var_513.text,this.var_1466));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_968 = this.var_34.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_969 = this.var_968.offences[_loc3_];
         this.var_513.text = this.var_969.msg;
         this.var_617 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModKickMessageComposer(this.var_1465,this.var_513.text,this.var_1466));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1212.selection < 0)
         {
            this.var_34.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_34.connection.send(new ModBanMessageComposer(this.var_1465,this.var_513.text,this.getBanLength(),this.var_1466));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1212.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1211.destroy();
            this.var_1211 = null;
         }
         if(this.var_1213 != null)
         {
            this.var_1213.destroy();
            this.var_1213 = null;
         }
         this.var_1212 = null;
         this.var_513 = null;
