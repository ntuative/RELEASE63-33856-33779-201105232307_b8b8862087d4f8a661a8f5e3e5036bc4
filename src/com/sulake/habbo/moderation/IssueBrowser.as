package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2233:String = "my_issues";
      
      private const const_2235:String = "open_issues";
      
      private const const_2234:String = "picked_issues";
      
      private const const_2253:String = "closed_issues";
      ...
      private var var_1896:IIssueBrowserView;
      
      private var var_1897:IIssueBrowserView;
      
      private var var_1895:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_265 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_265.numTabItems)
            {
               _loc5_ = this.var_265.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_49,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_265 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_265 == null || this.var_265.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_265.selector.getSelectableByName("open_issues");
         this.var_265.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_379.view.width = this.var_265.container.width;
         this.var_379.view.height = this.var_265.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2233:
               if(this.var_1896 == null)
               {
                  this.var_1896 = new MyIssuesView(this.issueManager,this,this.var_265.container);
               }
               return this.var_1896;
            case this.const_2235:
               if(this.var_1897 == null)
               {
                  this.var_1897 = new OpenIssuesView(this.issueManager,this,this.var_265.container);
               }
               return this.var_1897;
            case this.const_2234:
               if(this.var_1895 == null)
               {
                  this.var_1895 = new PickedIssuesView(this.issueManager,this,this.var_265.container);
               }
