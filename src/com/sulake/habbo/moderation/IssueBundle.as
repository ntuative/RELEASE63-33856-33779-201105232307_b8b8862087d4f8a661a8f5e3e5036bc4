package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_733:IssueMessageData = null;
      
      private var var_732:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2289 = param2.pickerUserId;
         this.var_2288 = param2.pickerUserName;
         this.var_1516 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1139 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1140;
         }
         if(this.var_733 == null || param1.timeStamp < this.var_733.timeStamp)
         {
            this.var_733 = param1;
         }
         if(this.var_732 == null || param1.priority > this.var_732.timeStamp)
         {
            this.var_732 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1139 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1140;
            }
            if(this.var_733 == _loc2_)
            {
               this.var_733 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_732;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_733;
         if(_loc2_ == null)
         {
