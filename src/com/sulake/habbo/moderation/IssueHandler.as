package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1256:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_164.getHighestPriorityIssue();
         this.var_527 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         this.var_1256 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         ...
         if(this.var_164.reportedUserId > 0)
         {
            this.var_1256.load(_loc4_,this.var_164.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_164.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_164.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_67 != null && this.var_67.issueManager != null && this.var_164 != null)
         {
            this.var_67.issueManager.removeHandler(this.var_164.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_164.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_164.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_164.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.releaseBundle(this.var_164.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_164.getHighestPriorityIssue().issueId;
         this.var_67.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_67,WindowTracker.const_1154,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_164.getHighestPriorityIssue();
            this.var_527 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
