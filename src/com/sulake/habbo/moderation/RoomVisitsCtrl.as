package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1950:int = 200;
      ...
      {
         this.var_803 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1540)
         {
