package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1611:ICheckBoxWindow;
      
      private var var_1612:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_366));
         Logger.log("BEGINNING TO SHOW: " + this.var_366);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1785;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_366);
         if(param1.flatId != this.var_366)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_366);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1079 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1611 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1612 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_862,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_1079.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1864,_loc2_,this.var_513.text,"",""));
         if(this.var_1611.isSelected || this.var_1612.isSelected || this.var_1079.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1611.isSelected,this.var_1612.isSelected,this.var_1079.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1887);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1807);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1245.selection];
         if(_loc3_ != null)
         {
            this.var_617 = false;
