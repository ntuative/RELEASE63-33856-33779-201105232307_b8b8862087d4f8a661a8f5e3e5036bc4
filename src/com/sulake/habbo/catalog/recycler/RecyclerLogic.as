package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1042:int = 0;
      ...
      {
         return this.var_619 != const_1042;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1832 != RecyclerStatusMessageEvent.const_1133;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_619 == const_451;
      }
      ...
      {
         this.var_619 = const_1043;
         this.var_123 = new Array(const_214);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1832)
         {
            case RecyclerStatusMessageEvent.const_1763:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1133:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1914:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1181:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1736:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_123[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_214)
            {
               oldObjectData = this.var_123[newSlotId];
         ...
         this.var_123[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_123[param1].id))
         {
            return;
         }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_123.length < const_214)
         {
            return false;
         }
         var _loc1_:int = 0;
