package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_659:uint = 1;
      ...
      private var var_1155:IRoomSession;
      ...
      private var var_377:ICatalogNavigator;
      
      private var var_109:Purse;
      
      private var var_96:RecyclerLogic;
      ...
      private var var_205:ChargeConfirmationDialog;
      ...
      private var var_2602:Boolean = true;
      
      private var var_1890:Boolean = false;
      
      private var var_2600:GiftWrappingConfiguration;
      
      private var var_1255:ClubGiftController;
      
      private var var_526:ClubBuyController;
      
      private var var_784:Map;
      
      private var var_1254:Boolean = false;
      
      private var var_782:IPurchasableOffer;
      
      private var var_1513:IDragAndDropDoneReceiver;
      
      private var var_59:PlacedObjectPurchaseData;
      
      private const const_1943:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1783);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_376.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_526.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_376.loadProductData(this);
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_377.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_188.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_784.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_109.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_96 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_96.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_96.active && this.mainWindowVisible());
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_377 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_659) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1943;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1890 = param1.session.isPrivateRoom;
               this.var_1155 = param1.session;
               if(this.var_96 != null)
               {
                  this.var_96.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_92:
               ...
               if(this.var_96 != null)
               {
                  this.var_96.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_96 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1255 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_526 == null)
         {
            this.var_526 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_377.buildCatalogIndex(_loc2_);
         if(this.var_783 && this.var_783 != "")
         {
            this.var_377.openPage(this.var_783);
            this.var_783 = "";
            this.var_1006 = -1;
         }
         else if(this.var_1006 > -1)
         {
            this.var_377.openPageById(this.var_1006,this.var_1891);
            this.var_1006 = -1;
            this.var_1891 = -1;
            this.var_783 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2601 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1310);
         }
         this.var_2601 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_69,this.var_109.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2602 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1138);
         }
         this.var_2602 = false;
         if(this.var_205 != null && !this.var_205.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_111,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_111,_loc2_.points["null"]));
         }
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1255.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_96 == null)
         {
            return;
         }
         this.var_96.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_96.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_96.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2600 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_205 == null || this.var_205.disposed)
         {
            this.var_205 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_205.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_784.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_784.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_188.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_188.keyExists("catalog.drag_and_drop") || this.var_188.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1155 || !this.var_1155.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_201);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_206);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_205);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1254 && param1.type == RoomEngineObjectEvent.const_145)
         {
            this.resetPlacedOfferData(true);
            if(this.var_782 == null || this.var_782.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_782.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_59 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_782);
            _loc5_ = this.var_1513;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_309,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_59 != null && this.var_59.productClassId == param1.classId)
         {
            if(this.var_59.roomCategory == this._roomEngine.activeRoomCategory && this.var_59.roomId == this._roomEngine.activeRoomId)
            {
               ...
               {
                  case FurniCategory.const_304:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_206);
                  ...
                  case FurniCategory.const_303:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_201);
                  ...
                  case FurniCategory.const_312:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_205);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_659);
            if(_loc1_ != null)
            {
