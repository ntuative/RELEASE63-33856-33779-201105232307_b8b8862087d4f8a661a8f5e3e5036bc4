package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2251:int = 10;
      ...
      private const const_1974:uint = 4.293848814E9;
      
      private const const_1975:uint = 4.294967295E9;
      
      private const const_1400:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1337 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            _loc6_.addEventListener(WindowEvent.const_106,this.onNameInputChange);
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_523,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1974 = _loc1_.stuffTypes;
            this.var_865 = _loc1_.boxTypes;
            this.var_864 = _loc1_.ribbonTypes;
            this.var_1336 = this.var_1974[0];
            this.var_401 = this.var_865[0];
            this.var_399 = this.var_864[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_399 < 0)
         {
            this.var_399 = this.var_864.length - 1;
         }
         if(this.var_399 > this.var_864.length - 1)
         {
            this.var_399 = 0;
         }
         if(this.var_401 < 0)
         {
            this.var_401 = this.var_865.length - 1;
         }
         if(this.var_401 > this.var_865.length - 1)
         {
            this.var_401 = 0;
         }
         var _loc1_:int = this.var_865[this.var_401] * 1000 + this.var_864[this.var_399];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1336,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1613 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1974)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc3_,ProductTypeEnum.const_80);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1336);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_865[this.var_401]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_864[this.var_399]);
         this._catalog.purchaseProductAsGift(this.var_1615,this.var_1337,this.var_1614,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1615,this.var_1337,this.var_1614);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2916 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_225)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2251)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2916 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_400 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_400 + 1);
               break;
      ...
      {
         if(this.var_283 == null || !this.var_283.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_283.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_400) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_283 == null)
         {
            this.var_283 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_866 == null)
         {
            this.var_866 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_283 == null || this.var_866 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_283.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_866.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_283.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_400) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_400);
         }
         this.var_400 = param1;
         if(this.var_400 < 0)
         {
            this.var_400 = _loc2_.numListItems - 1;
         }
         if(this.var_400 >= _loc2_.numListItems)
         {
            this.var_400 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_400) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1400;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1974) : uint(this.const_1975);
      }
      ...
      {
         this.var_1336 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1336;
               }
            }
            _loc4_++;
         }
