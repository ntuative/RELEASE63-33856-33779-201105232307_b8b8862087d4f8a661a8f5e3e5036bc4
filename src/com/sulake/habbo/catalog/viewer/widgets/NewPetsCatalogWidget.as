package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_106,this.onTextWindowEvent);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_213 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1481 && _loc2_ < this.var_213.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_523,this.var_213[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_213 != null && this.var_213.length > 0)
         {
            ...
            this.var_374 = this.var_213[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_523,this.var_374),this.getRaceLocalizationKey(this.var_523,this.var_374));
            }
         }
         return this.getRaceLocalizationKey(this.var_523,this.var_374);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_374 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_523;
         var _loc3_:int = this.var_374;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_374 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
