package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_427:IButtonWindow;
      ...
      {
         super(param1);
         this.var_427 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1313 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_427 != null)
         {
            this.var_427.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_427.disable();
         }
         this.var_1312 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_427 != null)
         {
            this.var_427.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_1057,HabboMusicPrioritiesEnum.const_199,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1057 = parseInt(_loc2_.extraParam);
            if(this.var_1312 != null)
            {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1313.text = _loc8_;
            }
         }
         else if(this.var_1313 != null)
         {
            this.var_1313.text = "";
         }
         if(this.var_427 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1057);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1057);
         }
         return -1;
      }
