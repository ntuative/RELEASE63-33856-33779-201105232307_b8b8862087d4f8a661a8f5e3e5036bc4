package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_203[this.var_520][this.var_589];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_520 = var_477.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_520];
         var _loc3_:Array = this.var_203[this.var_520] as Array;
         ...
         events.dispatchEvent(new CatalogWidgetColoursEvent(_loc4_,"ctlg_clr_40x32_1","ctlg_clr_40x32_2","ctlg_clr_40x32_3",this.var_589));
      }
      
      override public function startDragAndDrop(param1:IGridItem) : Boolean
      {
         var _loc2_:Array = this.var_203[this.var_520] as Array;
         var _loc3_:Offer = _loc2_[this.var_589] as Offer;
         if(_loc3_ != null)
         {
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_589 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_589] as Offer;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_203[this.var_520] as Array;
         var _loc2_:Offer = _loc1_[this.var_589] as Offer;
         var_217 = _loc2_.productContainer as ProductGridItem;
         var_217.activate();
      }
         ...
         for each(_loc1_ in page.offers)
         {
            if(_loc1_.pricingModel == Offer.const_435 || _loc1_.pricingModel == Offer.const_397)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_63 || _loc3_.productType == ProductTypeEnum.const_80)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_203[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
