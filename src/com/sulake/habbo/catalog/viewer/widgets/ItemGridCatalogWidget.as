   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_882,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_272,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_710,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_242,this.deActivateScrollbar);
         }
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_730 >= 0 && this.var_730 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_730];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_519)
         {
            ++this.var_1691;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1691);
         }
      }
