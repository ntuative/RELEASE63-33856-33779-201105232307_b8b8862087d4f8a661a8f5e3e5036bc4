package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_106,this.onTextWindowEvent);
         ...
         this.var_2567 = _loc3_.localizationId;
         this.var_394 = [];
         if(page && false && page.viewer.catalog)
         {
         ...
         events.addEventListener(WidgetEvent.const_800,this.onApproveNameResult);
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent = null) : void
      {
         ...
         var _loc3_:* = [];
         for each(_loc4_ in this.var_394)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_562 = param1.index;
         if(this.var_562 < 0 || this.var_562 > this.var_394.length)
         {
            this.var_562 = 0;
         }
         this.updateImage();
      ...
      {
         if(param1.productCode == this.var_2567)
         {
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_213 == null || this.var_854 >= this.var_213.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_562 >= 0 && this.var_562 < this.var_394.length)
         {
            _loc7_ = this.var_394[this.var_562] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_213[this.var_854] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_523,_loc3_,_loc2_,AvatarScaleType.const_57,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_314,AvatarAction.const_928);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_562 >= this.var_394.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_394[this.var_562] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_213[this.var_854] as int;
