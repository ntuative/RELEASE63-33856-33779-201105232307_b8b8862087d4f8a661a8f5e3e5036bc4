package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1443:int = 16763904;
      
      private static const const_1441:int = 13421772;
      
      private static const const_1442:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_89 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         _loc4_ = this.var_261.getWithIndex(this.var_305);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_769);
            if(_loc3_ == null)
            {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1443);
         _loc2_.push(const_1441);
         _loc2_.push(const_1442);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_261.getWithIndex(this.var_305);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_769);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_305;
         if(this.var_305 >= this.var_261.length)
         {
            this.var_305 = 0;
         }
         var _loc2_:Map = this.var_261.getWithIndex(this.var_305);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_305 < 0)
         {
            this.var_305 = this.var_261.length - 1;
         }
         var _loc2_:Map = this.var_261.getWithIndex(this.var_305);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean) : void
      {
         ...
         if(this.var_89 != null)
         {
            ...
            _loc3_ = new Point((this.var_89.width - param1.width) / 2,(this.var_89.height - param1.height) / 2);
            this.var_89.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
