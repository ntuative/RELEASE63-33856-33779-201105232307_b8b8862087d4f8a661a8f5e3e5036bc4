package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_993:ITextWindow;
      
      private var var_1238:ITextWindow;
      
      private var var_89:IBitmapWrapperWindow;
      
      private var var_1872:Point;
      
      private var var_521:IItemGridWindow;
      
      private var var_1499:IScrollbarWindow;
      
      protected var var_2014:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_993 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1238 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_89 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1872 = new Point(this.var_89.x,this.var_89.y);
         this.var_521 = _window.findChildByName("bundleGrid") as IItemGridWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_993.text = _loc4_;
         this.var_1238.text = _loc5_;
         this.var_993.height = this.var_993.textHeight + 5;
         this.var_1238.y = this.var_993.y + this.var_993.height;
         this.var_1238.height = Math.max(130,this.var_1238.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_519:
                  _loc6_ = this.var_1873.clone();
                  if(this.var_521 != null)
                  {
                     this.var_521.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_521,this.var_1499,this.var_2014);
                     this.var_521.scrollV = 0;
                  }
                  break;
               ...
               case Offer.const_397:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_202:
                        ...
                        _loc6_ = new BitmapData(this.var_89.width,this.var_89.height,false,_loc13_);
                        _loc14_ = null;
                        _loc15_ = page.viewer.catalog as HabboCatalog;
                        if(_loc15_.avatarRenderManager != null)
                        {
                           _loc17_ = _loc15_.sessionDataManager.figure;
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_57);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_53,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_314,AvatarAction.const_620);
                              _loc16_.appendAction(AvatarAction.const_356,_loc8_.productClassId);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_89);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2561)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2561 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_89 != null && true)
         {
            ...
            if(this.var_89.bitmap == null)
            {
               this.var_89.bitmap = new BitmapData(this.var_89.width,this.var_89.height,true,16777215);
            }
            this.var_89.bitmap.fillRect(this.var_89.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_89.width - param1.width) / 2,(this.var_89.height - param1.height) / 2);
            this.var_89.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_89.invalidate();
            this.var_89.x = this.var_1872.x;
            this.var_89.y = this.var_1872.y;
            if(param3 != null)
            {
               this.var_89.x += param3.x;
               this.var_89.y += param3.y;
            }
         }
         if(param2)
         {
