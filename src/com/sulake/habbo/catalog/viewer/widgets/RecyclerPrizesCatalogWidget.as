package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_2014:XML;
      
      private var var_2015:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_677 = this.recycler.getPrizeTable();
         ...
         this.var_2015 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_677.length > 0 && this.var_677[0].prizes.length > 0)
         {
            this.select(this.var_677[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_677.length)
         {
            this.createLevelItem(this.var_677[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2015) as IWindowContainer;
      ...
      private function createPrizeItem(param1:PrizeContainer, param2:IItemGridWindow) : void
      {
         ...
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2014) as IWindowContainer;
