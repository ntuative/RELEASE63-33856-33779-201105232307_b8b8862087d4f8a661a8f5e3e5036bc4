package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         if(!this.var_378.disposed)
         {
            this.var_378.destroyGridItems();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_378 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.method_2) as BitmapDataAsset;
         this.var_1007 = _loc4_.content as BitmapData;
         ...
         this.select(this.var_378.getGridItemAt(param1.index) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         for each(_loc2_ in param1.colours)
         {
            this.var_1008.push(_loc2_.slice());
         }
         _loc3_ = page.viewer.catalog.assets.getAssetByName(param1.backgroundAssetName) as BitmapDataAsset;
         this.var_637 = _loc3_.content as BitmapData;
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.method_2) as BitmapDataAsset;
         ...
         this.var_955 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_378.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1008.length,this.var_378.numGridItems]);
         this.var_378.destroyGridItems();
         this.var_217 = null;
         for each(_loc1_ in this.var_1008)
         {
            if(_loc1_.length > 0)
            {
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1893) as IWindowContainer;
               ...
               this.var_378.addGridItem(_loc2_);
               ...
               if(_loc4_ != null)
               {
                  _loc4_.bitmap = new BitmapData(this.var_1007.width,this.var_1007.height,true,0);
                  _loc6_ = 255;
                  _loc7_ = 255;
                  _loc8_ = 255;
                  _loc9_ = null;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_378.getGridItemIndex(param1.target as IWindow);
