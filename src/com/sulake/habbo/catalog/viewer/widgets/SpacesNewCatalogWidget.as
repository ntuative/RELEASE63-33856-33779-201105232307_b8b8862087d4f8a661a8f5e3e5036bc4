package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_437:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_437 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_437)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_437.numSelectables)
            {
               _loc3_ = this.var_437.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_106[this.var_520]);
      ...
      {
         var _loc2_:int = this.var_589[this.var_520];
         var _loc3_:Offer = this.var_203[this.var_520][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_477.numGridItems)
         {
            _loc2_ = this.var_203[this.var_520][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_589[this.var_520] = (this.var_203[this.var_520] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_589[0];
         var _loc2_:int = this.var_589[1];
         var _loc3_:int = this.var_589[2];
         var _loc4_:Offer = this.var_203[0][_loc1_];
         var _loc5_:Offer = this.var_203[1][_loc2_];
         var _loc6_:Offer = this.var_203[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_435 || _loc1_.pricingModel == Offer.const_397))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_63 || _loc2_.productType == ProductTypeEnum.const_80))
            {
               continue;
            }
            ...
            while(this.var_203.length < this._groupNames.length)
            {
               this.var_203.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_203[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_203[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_437.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_437.setSelected(this.var_437.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_203[this.var_520],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_589[this.var_520];
