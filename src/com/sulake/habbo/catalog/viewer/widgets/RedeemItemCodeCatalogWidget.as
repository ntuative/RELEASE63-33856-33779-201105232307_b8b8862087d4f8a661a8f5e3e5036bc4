package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_934.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_934 = null;
         }
         if(this.var_933 != null)
         {
            this.var_933.removeEventListener(WindowKeyboardEvent.const_207,this.windowKeyEventProcessor);
            this.var_933 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_934 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_934 != null)
         {
            this.var_934.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_933 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_933 != null)
         {
            this.var_933.addEventListener(WindowKeyboardEvent.const_207,this.windowKeyEventProcessor);
         }
         return true;
      }
