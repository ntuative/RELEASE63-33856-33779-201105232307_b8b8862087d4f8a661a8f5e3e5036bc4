package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1040:Object = {"frontpage3":[7,8]};
      ...
      {
         if(param1 < this.var_759.length)
         {
            return this.var_759[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_759.length)
         {
            _loc2_ = String(this.var_759[param1]).replace("#","0x");
