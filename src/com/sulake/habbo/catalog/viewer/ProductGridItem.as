package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1036:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_204:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_524:Object;
      ...
      {
         this._view.getChildByName(const_1036).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1036).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_85,MouseCursorType.const_988);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_988);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_204.select(this);
            this.var_524 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_524 != null && this.var_524 == param2)
         {
            _loc3_ = this.var_204.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_524 = null;
            }
