package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1925:String = "ctlg_";
       
      
      protected var var_2149:XML;
      ...
      private var var_490:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1106:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_490 = new EventDispatcher();
      ...
      {
         var _loc2_:String = const_1925 + param1;
         ...
         this.var_2149 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2149) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1624:
               if(this.var_1106 == null)
               {
                  this.var_1106 = new ItemGridCatalogWidget(param1);
                  this.var_36.push(this.var_1106);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1641:
               ...
               break;
            case CatalogWidgetEnum.const_1653:
            ...
            case CatalogWidgetEnum.const_1737:
               ...
               break;
            case CatalogWidgetEnum.const_1840:
               this.var_36.push(new RoomPreviewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1752:
            ...
            case CatalogWidgetEnum.const_1712:
               ...
               break;
            case CatalogWidgetEnum.const_1678:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_490.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_490 != null)
         {
            return this.var_490.dispatchEvent(param1);
         }
         return false;
      }
