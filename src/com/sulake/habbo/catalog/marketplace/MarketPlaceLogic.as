package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1382:String = "poster";
       
      
      public const const_2044:int = 1;
      
      public const const_2001:int = 2;
      
      public const const_2254:int = 3;
      ...
      private var var_2815:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_323);
            this.var_323 = null;
         }
         this._disposed = true;
      }
      ...
      {
         this.requestOffers(this.var_2816,this.var_2817,this.var_2332,this.var_2813);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2044,_loc2_);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2814 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_323.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_323.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2410 || param1.furniTypeId != this.var_2411)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1382)
               {
                  _loc2_ = true;
               }
            }
      ...
      public function getNameLocalizationKey(param1:IMarketPlaceOfferData) : String
      {
         ...
         if(param1 != null)
         {
            ...
            else if(param1.furniType == MarketPlaceOfferData.const_74)
            {
