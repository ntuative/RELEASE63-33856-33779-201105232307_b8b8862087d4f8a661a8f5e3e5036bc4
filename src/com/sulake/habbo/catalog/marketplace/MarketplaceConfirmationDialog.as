package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_845:MarketPlaceLogic;
      ...
      private var var_98:MarketPlaceOfferData;
      ...
      public function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         ...
         this.var_98 = param2;
         if(!this.var_845 || !this._catalog || !this._catalog.localization)
         {
            return;
         }
         if(this._window)
         ...
         if(_loc3_)
         {
            if(param1 == this.var_845.const_2044)
            {
               _loc3_.text = "${catalog.marketplace.confirm_header}";
            }
            if(param1 == this.var_845.const_2001)
            {
         ...
         if(_loc3_)
         {
            _loc3_.text = "${" + this.var_845.getNameLocalizationKey(param2) + "}";
         }
         ...
         if(_loc3_)
         {
            ...
            _loc4_ = _loc4_.replace("%price%",this.var_98.price);
            _loc3_.text = _loc4_;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%days%",this.var_845.averagePricePeriod.toString());
               _loc6_ = this.var_98.averagePrice == 0 ? " - " : this.var_98.averagePrice.toString();
         ...
         if(_loc3_)
         {
            ...
            {
               _loc4_ = _loc5_.raw;
               _loc4_ = _loc4_.replace("%count%",this.var_98.offerCount);
               _loc3_.text = _loc4_;
            }
            else
            {
      ...
      private function setImage() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         if(!this.var_98 || !this._window || !this._roomEngine)
         {
            return;
         }
         if(!this.var_98.image)
         {
            if(this.var_98.furniType == 1)
            {
               _loc1_ = this._roomEngine.getFurnitureIcon(this.var_98.furniId,this);
            }
            else if(this.var_98.furniType == 2)
            {
               _loc1_ = this._roomEngine.getWallItemIcon(this.var_98.furniId,this);
            }
            if(_loc1_ && _loc1_.data)
            {
               this.var_98.image = _loc1_.data as BitmapData;
               this.var_98.imageCallback = _loc1_.id;
            }
         }
         if(this.var_98.image != null)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc2_.bitmap.draw(this.var_98.image,new Matrix(1,0,0,1,(_loc2_.width - this.var_98.image.width) / 2,(_loc2_.height - this.var_98.image.height) / 2));
            }
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "buy_button":
               this._catalog.buyMarketPlaceOffer(this.var_98.offerId);
               this.hide();
               break;
      ...
      {
         if(this.var_98 && this.var_98.imageCallback == param1)
         {
            this.var_98.image = param2;
            this.setImage();
         }
      }
