package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1381:Number = 4285716709;
      ...
      private var var_1692:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2947:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1692 == 4294967295)
            {
               this.var_1692 = _loc1_.color;
            }
            _loc1_.color = const_1381;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1685;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1845;
            }
         }
      }
      ...
      {
         this.var_58 = navigator.catalog.windowManager.buildFromXML(var_1406) as IItemListWindow;
         if(this.var_58 == null)
         {
