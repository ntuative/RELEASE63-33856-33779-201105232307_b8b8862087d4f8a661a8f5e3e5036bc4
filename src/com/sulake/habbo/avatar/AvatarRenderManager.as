package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2250:String = "hd-99999-99999";
      ...
      private var var_2093:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_337 = RenderMode.const_1816;
         this.var_328 = new Map();
         this.var_111 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_116,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_111.add(AvatarType.const_116,_loc4_);
         ...
         this.var_111.add(AvatarType.const_55,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_329.init();
         this.var_861.init();
         _loc2_ = this.var_111.getValue(AvatarType.const_116) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_111.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_111.getValue(AvatarType.const_116) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1020)
         {
            if(this.var_2904 && this.var_2903 && this.var_2905)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_111.getValue(AvatarType.const_116) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_2093)
         {
            this.var_2093 = new AvatarFigureContainer(this.const_2250);
         }
         this.var_240.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2093,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_328.getKeys())
         {
            _loc4_ = this.var_328.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1738)
         {
            _loc6_ = !this.var_329.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_329.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_111.getValue(AvatarType.const_55) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_111.getValue(AvatarType.const_55);
      ...
      {
         var _loc3_:AvatarStructure = this.var_111.getValue(AvatarType.const_116) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_116:
               _loc3_ = this.var_111.getValue(AvatarType.const_116) as AvatarStructure;
               break;
            case AvatarType.const_55:
               _loc3_ = this.var_111.getValue(AvatarType.const_55) as AvatarStructure;
               break;
            default:
