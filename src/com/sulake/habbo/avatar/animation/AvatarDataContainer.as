package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2020:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_2664 = parseInt(_loc3_,16);
         ...
         this.var_753 = new ColorTransform(this.var_2020,this.var_2021,this.var_2022,this._alphaMultiplier);
         this.var_1268 = this.generatePaletteMapForGrayscale(this.var_2664,this.var_2666);
      }
      ...
      {
         return this.var_1268.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1268.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1268.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1268.getValue("alphas") as Array;
      }
