package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1470:String = "Default";
      
      private static const const_1468:int = 2;
      
      private static const const_1469:String = AvatarSetType.const_35;
      ...
      protected var var_696:AvatarFigureContainer;
      
      protected var var_573:IAvatarDataContainer;
      
      protected var var_335:Array;
      
      protected var var_47:BitmapData;
      
      private var var_991:IActiveActionData;
      ...
      private var var_2669:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1469,const_1468);
         this.var_335 = new Array();
         this.var_991 = new ActiveActionData(AvatarAction.const_434);
         this.var_991.definition = this._structure.getActionDefinition(const_1470);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_696,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1866;
         if(param2 < AvatarDirectionAngle.const_1180)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_650,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_269.length == 1 && this.var_93 == this.var_1813)
         {
            return this.var_93 + this.var_534 + this.var_650 % 4;
         }
         if(this.var_269.length == 2)
         {
            for each(_loc1_ in this.var_269)
            {
               ...
               {
                  return this.var_93 + this.var_534 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_650 % 11;
                  return this.var_93 + "_" + this.var_1813 + this.var_534 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2668 || param2 != this.var_2669 || param1 != this.var_2670)
         {
            this.var_2668 = param3;
            this.var_2669 = param2;
            this.var_2670 = param1;
            this.var_1926 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1355 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1355)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_287.definition.geometryType,this.var_93);
         this.var_47.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_650);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_287.definition.geometryType,this.var_93);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_650);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_335.push(new ActiveActionData(param1,param2,this.var_650));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_991;
         this.var_287.definition = this.var_991.definition;
         this.resetBodyPartCache(this.var_991);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_534 = "";
         this.var_269 = this._structure.sortActions(this.var_335);
         if(this.var_269 == null)
         {
            this.var_761 = new Array(0,0,0);
            if(this.var_1270 != "")
            {
               _loc1_ = true;
               this.var_1270 = "";
         ...
         {
            this.var_761 = this._structure.getCanvasOffsets(this.var_269,this._scale,this.var_93);
            for each(_loc4_ in this.var_269)
            {
               this.var_534 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_356)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1526 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1526 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1270 != this.var_534)
            {
               _loc1_ = true;
               this.var_1270 = this.var_534;
            }
         }
         this.var_1491 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_269)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_990 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1866 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_324 || _loc1_.actionType == AvatarAction.const_234 || _loc1_.actionType == AvatarAction.const_444)
               {
                  this.var_990 = true;
               }
            }
