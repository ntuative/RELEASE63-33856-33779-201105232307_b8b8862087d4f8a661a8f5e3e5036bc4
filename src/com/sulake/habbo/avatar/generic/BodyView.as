package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_646:String = "tab_boy";
      
      private const const_647:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_69.controller.gender)
         {
            case FigureData.const_79:
               activateTab(this.const_646);
               inactivateTab(this.const_647);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_647);
               inactivateTab(this.const_646);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_646:
                  var_69.controller.gender = FigureData.const_79;
