package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2524 = parseInt(param1.@precedence);
         this.var_2528 = String(param1.@activepartset);
         this.var_2526 = String(param1.@assetpartdefinition);
         this.var_2530 = String(param1.@lay);
         this.var_749 = String(param1.@geometrytype);
         this.var_2527 = Boolean(parseInt(param1.@main));
         this.var_2529 = Boolean(parseInt(param1.@HabboAvatarEditorCom_bottom_trousers_on));
         this.var_2531 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "HabboAvatarEditorCom_bottom_trousers_on")
            {
               this.var_2525 = _loc6_;
            }
            else
            {
               this.var_1803[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_761.getValue(param1) == null)
         {
            this.var_761.add(param1,new Map());
         }
         var _loc4_:Map = this.var_761.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_761.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1803[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2525;
         }
         return _loc2_;
      }
