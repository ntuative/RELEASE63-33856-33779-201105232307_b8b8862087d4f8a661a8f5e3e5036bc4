package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2245 = parseInt(param1.@paletteid);
         this.var_588 = new Dictionary();
         this.var_588["F"] = new Dictionary();
         this.var_588["M"] = new Dictionary();
         this.var_588["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_588["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_588["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_588["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      public function cleanUp(param1:XML) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         for each(_loc2_ in param1["GetCfhChatlogMessageComposer"])
         {
      ...
      {
         return this.var_588[param1.toUpperCase()][Math.min(param2,1)];
      }
