package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2252:int = 2;
      
      private var _parts:Array;
      
      private var var_257:Array;
      
      private var var_957:int = -1;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_957 >= 0 && this._parts.length > this.var_957)
         {
            _loc2_ = this._parts[this.var_957];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      {
         return this._parts[this.var_957] as AvatarEditorGridPartItem;
      }
