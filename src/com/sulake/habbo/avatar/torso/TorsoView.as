   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_296,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_211,_windowManager,_assetLibrary);
         ...
         if(var_69 && var_153 == "")
         {
            var_69.switchCategory(FigureData.const_211);
         }
      }
