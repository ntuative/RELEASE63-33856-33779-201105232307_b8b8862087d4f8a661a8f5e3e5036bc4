package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1338:IWindowContainer;
      
      public static var var_1618:IWindowContainer;
      ...
      private var var_344:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1107 = [];
         this.var_1383 = [AvatarEditorFigureCategory.const_730,AvatarEditorFigureCategory.const_53,AvatarEditorFigureCategory.const_248,AvatarEditorFigureCategory.const_776,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1338 == null)
         {
            ...
            var_1338 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1618 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1618 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_413 = new Timer(1000);
         this.var_413.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1383;
         }
         for each(_loc6_ in param4)
         {
            this.var_1107.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_413.stop();
            this.var_413.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_413 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1383);
         }
         if(param1.length != this.var_1107.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2213 = this.canChangeOutfit();
            this.var_413.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_344 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_344.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_344.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1107.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_344.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_344.numSelectables)
               {
                  this.var_344.getSelectableAt(_loc6_).x = this.var_344.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_344.setSelected(this.var_344.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1383;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1668 == AvatarEditorSideCategory.const_105 || this.var_2215))
         {
         ...
         this.setViewToCategory(this.var_361);
      }
      ...
      {
         if(this.var_1668 == AvatarEditorSideCategory.const_105)
         {
            this.var_2215 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarEditorSideCategory.const_510:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_510);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_361 = param1;
         this.var_344.setSelected(this.var_344.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2214 = new Date().valueOf();
                  this.var_2213 = false;
                  this.var_413.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2214 > 5000;
      }
   }
}
