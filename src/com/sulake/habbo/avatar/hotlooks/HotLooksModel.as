package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_2096:String = "hot_looks";
      
      public static const const_2121:String = "my_looks";
      ...
      {
         super(param1);
         this.var_497 = new Dictionary();
         this.var_497["null"] = new Array();
         this.var_497["null"] = new Array();
         this.var_497["undefined.index"] = 0;
         this.var_497["undefined.index"] = 0;
      ...
      {
         var _loc2_:Array = this.var_497["null"];
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (this.var_497[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
