package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_696:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_696 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_696.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1492 = this.var_1187;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_53)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1492);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_650);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_696,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1492 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_650);
                  _loc20_ = this.var_93;
                  _loc21_ = 1;
                  switch(this.var_93)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_650);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_696,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_98)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_650);
                  _loc21_ = this.var_93;
                  _loc22_ = 1;
                  switch(this.var_93)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_534 = this.var_534 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_371:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1747:
                  case AvatarAction.const_1283:
                  case AvatarAction.const_1214:
                  case AvatarAction.const_1861:
                  case AvatarAction.const_1729:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_991);
         this.getCache().resetBodyPartCache(this.var_991);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1490 = this._structure.sortActions(this.var_335);
         ...
         {
            this.var_761 = this._structure.getCanvasOffsets(this.var_1490,this._scale,this.var_93);
         }
      }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1187 = _loc4_.id;
                     this.var_1800 = _loc4_.breed;
                     break;
                  }
               }
            }
