package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      {
         if(param1 == null || this.var_510 == null)
         {
            return;
         }
         var _loc2_:int = this.var_510.indexOf(param1);
         if(_loc2_ != -1)
         {
      ...
      {
         var _loc1_:* = null;
         while(this.var_510.length > 0)
         {
            _loc1_ = this.var_510.pop() as IPetDataListener;
      ...
      public function getPetData(param1:int, param2:IPetDataListener = null) : IPetData
      {
         ...
         if(_loc3_ == null)
         {
            this.assetsReady(param1,AvatarScaleType.const_57,param2);
         }
         return _loc3_;
      }
            ...
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.GetCfhChatlogMessageComposer.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_98)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1458.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_614.getValue(_loc6_) == null)
               {
                  ...
                  this.var_614.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_510.indexOf(param3) == -1)
                  {
                     this.var_510.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_614.getKeys())
         {
            _loc5_ = this.var_614.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
