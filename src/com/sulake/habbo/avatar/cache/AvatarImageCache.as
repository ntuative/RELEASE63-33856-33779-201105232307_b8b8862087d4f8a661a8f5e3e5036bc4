package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1947:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1576:IAvatarImage;
      ...
      private var var_91:AvatarCanvas;
      
      private var _disposed:Boolean;
      
      private var _bodyPartCache:AvatarImageBodyPartCache;
      
      private var var_359:IActiveActionData;
      
      private var var_457:AvatarImageBodyPartContainer;
      ...
      private var var_939:BitmapData;
      
      private var var_2382:ByteArray;
      
      private var var_2381:ImageData;
      
      private var var_897:PaletteMap;
      
      private var var_938:Array;
      
      private var var_940:Point;
      ...
      {
         if(this.var_749 == param1)
         {
            return;
         }
         if(this.var_749 == GeometryType.const_1311 && param1 == GeometryType.const_1208 || this.var_749 == GeometryType.const_1208 && param1 == GeometryType.const_1311)
         {
            this.var_749 = param1;
            this.var_91 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_359 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_359;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_359 || !this.var_359.definition))
         {
            if(this.var_359.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_359.definition.state + "." + this.var_359.actionParameter);
               _loc13_ = param2 - this.var_359.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_359.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_359 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_788)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_476)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1576.getFigure(),_loc5_,this.var_749,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_457 = _loc10_.getImageContainer(_loc4_);
         if(this.var_457 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_457 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_359);
            if(this.var_457 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_457,_loc4_);
         }
         this.var_457.offset = _loc8_;
         return this.var_457;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_91)
         {
            this.var_91 = this._structure.getCanvas(this._scale,this.var_749);
            if(!this.var_91)
            {
               return null;
            }
            this.var_2383 = new Point(0,this.var_91.height - int(this.var_91.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1796[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_692 || _loc10_ == AvatarAction.const_444;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1438 = this.var_118.bodyPartId;
               this.var_181 = this.var_118.partType;
               this.var_1751 = this.var_118.partId;
               this._frame = this.var_118.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  if(_loc9_ == "wav" && (this.var_181 == "lh" || this.var_181 == "ls" || this.var_181 == "lc" || this.var_181 == "lhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "drk" && (this.var_181 == "rh" || this.var_181 == "rs" || this.var_181 == "rc" || this.var_181 == "rhs"))
                  {
                     _loc7_ = true;
                  }
                  else if(_loc9_ == "crr" && this.var_181 == "rhs")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_181 == "ri")
                  {
                     _loc7_ = true;
                  }
                  else if(this.var_181 == "cp")
                  {
                     _loc7_ = true;
                  }
                  else
                  {
                     ...
                     if(this.var_118.flippedPartType != this.var_181)
                     {
                        this.var_181 = this.var_118.flippedPartType;
                     }
                  }
               }
               this.var_1439 = this._scale + "_" + this.var_118.action.assetPartDefinition + "_" + this.var_181 + "_" + this.var_1751 + "_" + _loc5_ + "_" + this._frame;
               this.var_435 = this._assets.getAssetByName(this.var_1439) as BitmapDataAsset;
               if(this.var_435 == null)
               {
                  this.var_1439 = this._scale + "_std_" + this.var_181 + "_" + this.var_1751 + "_" + _loc5_ + "_0";
                  this.var_435 = this._assets.getAssetByName(this.var_1439) as BitmapDataAsset;
               }
               if(!(!this.var_435 || !this.var_435.content))
               {
                  if(this.var_118.paletteMapId > -1)
                  {
                     this.var_897 = this._structure.renderManager.paletteManager.getPalette(this.var_118.paletteMapId);
                     if(this.var_897 != null)
                     {
                        this.var_939 = this.var_435.content as BitmapData;
                        this.var_180 = new BitmapData(this.var_939.width,this.var_939.height);
                        this.var_2382 = this.var_897.colorize(this.var_939.getPixels(this.var_939.rect));
                        this.var_180.setPixels(this.var_180.rect,this.var_2382);
                     }
                     else
                     {
                        this.var_180 = (this.var_435.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1438 == AvatarBodyPartType.const_248 || this.var_1438 == AvatarBodyPartType.const_1638 || this.var_1438 == AvatarBodyPartType.const_1640) && this.var_118.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_180.colorTransform(this.var_180.rect,this.var_118.color.colorTransform);
                  }
                  if(this.var_118.isBlendable)
                  {
                     this.var_180.colorTransform(this.var_180.rect,this.var_118.blendTransform);
                  }
                  this.var_940 = this.var_435.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_57)
                     {
                  ...
                  this.var_2381 = new ImageData(this.var_180,this.var_940,_loc7_);
                  this.var_938.push(this.var_2381);
               }
            }
            _loc8_--;
         }
         if(this.var_938.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_938,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2383.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_57)
            {
         ...
         _loc8_ = this.var_938.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_938.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
