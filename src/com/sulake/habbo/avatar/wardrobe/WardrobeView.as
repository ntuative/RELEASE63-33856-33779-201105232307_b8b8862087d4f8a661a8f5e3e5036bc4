package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_972:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_972 = this._window.findChildByName("hc_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(this.var_972)
               {
                  this.var_972.addListItem(_loc2_.view);
