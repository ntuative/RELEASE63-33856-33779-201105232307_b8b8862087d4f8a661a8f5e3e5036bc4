package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1063:AvatarActionManager;
      
      private var var_395:FigureData;
      ...
      private var var_991:ActionDefinition;
      
      private var var_563:String;
      
      private var var_1601:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_458 = param1;
         this.var_395 = new FigureData();
         this.var_475 = new PartSetsData();
      ...
      {
         this.var_1601.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_563);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_563);
            return;
         }
         this.var_1063 = new AvatarActionManager(param1,this.var_563,param2);
         this.var_991 = this.var_1063.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_563);
            return false;
         }
         if(this.var_475.parse(param1))
         {
            if(this.var_563 == AvatarType.const_116)
            {
               this.var_475.getPartDefinition("ri").appendToFigure = true;
               this.var_475.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_563);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_563);
            return false;
         }
         return this.var_395.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_395.injectXML(param1);
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_395.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_395.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_1063.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_1063.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_1063.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_689[param1])
         {
            this.var_689[param1] = new Dictionary();
         }
         if(this.var_689[param1][param2])
         {
            return this.var_689[param1][param2];
         }
         this.var_689[param1][param2] = this.var_395.getMandatorySetTypeIds(param1,param2);
         return this.var_689[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_395.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_1063.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_475.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_475.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1774[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_475.getActiveParts(param3.definition);
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_395.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_395.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_991;
                           }
                           _loc12_ = this.var_475.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_475.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1601.getOffset(param1,param2,param3,param4,param5,param6);
      }
