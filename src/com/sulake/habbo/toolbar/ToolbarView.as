package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1477:Point = new Point(3,3);
      
      private static const const_1475:uint = 7433577;
      
      private static const const_1476:uint = 5723213;
      
      private static const const_455:String = "_hover";
      
      private static const const_456:String = "_normal";
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1477;
         ...
         {
            this.setIconHoverState(_loc11_,const_456);
         }
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_759:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_938:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_455);
               this.setIconBgHoverState(_loc3_,const_455);
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_455 ? this.var_1497 : this.var_1498;
         }
         else
         {
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1498 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1497)
         {
            this.var_1497.dispose();
         }
         this.var_1497 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_992.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_1053;
            _loc2_.y = const_1053;
            this.var_992.add(param1,_loc2_);
         }
         return _loc2_;
      }
