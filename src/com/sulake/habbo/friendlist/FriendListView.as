package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1477:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2049:FriendListTabsView;
      ...
      private var var_1590:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2049 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1477;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_987 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_248 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_2049.prepare(this.var_987);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1152,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1313,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_962,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_984,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_962,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_984,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1590 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1590.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2050 == -1 ? 0 : int(this.var_17.height - this.var_2050);
         var _loc4_:int = this.var_2048 == -1 ? 0 : int(this.var_17.width - this.var_2048);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1177,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_962,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1152,false);
         ...
         this.var_2050 = this.var_17.height;
         this.var_2048 = this.var_17.width;
