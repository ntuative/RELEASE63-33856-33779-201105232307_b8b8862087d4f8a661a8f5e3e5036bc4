package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1651 != "")
         {
            friendList.refreshText(param1,"name_text_online",this.var_712,this.var_1651);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",this.var_712,this.var_1652);
         }
         friendList.refreshText(param1,"name_text_offline",!this.var_712,this.var_1652);
         friendList.refreshText(param1,"motto_text",this.var_712,this.var_2204);
         friendList.refreshButton(param1,"offline",!this.var_712,null,0);
         if(this.var_712)
         {
            this.refreshFigure(param1,this.var_2205);
