package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2552:FriendListLookAndFeel;
      
      private var var_437:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1864:OpenedToWebPopup;
      ...
      private var var_1863:AvatarSearchResults;
      ...
      {
         this.var_2552 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_106 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1863 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_772)
         {
            this.var_772.release(new IIDSessionDataManager());
            this.var_772 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1864 = new OpenedToWebPopup(this);
         }
         this.var_1864.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_417);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_317,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1060.createAvatarImage(param1,AvatarScaleType.const_98,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_982 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_1102,this.getText("friendlist.friends")));
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_401,this.getText("friendlist.friends.offlinecaption")));
         ...
         {
            _loc5_ = this.var_106.findCategory(FriendCategory.const_401);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_437.findTab(FriendListTab.const_99).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_437.findTab(FriendListTab.const_99);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1863.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_437.findTab(FriendListTab.const_99);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_772 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_772.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_772.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
