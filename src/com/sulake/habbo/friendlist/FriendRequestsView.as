package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1980:String = "no_reqs_info";
      ...
      {
         this.var_2072 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2073 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2073.procedure = this.onDismissAllButtonClick;
         this.var_2072.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_174)
         {
         ...
         else if(param1.state == FriendRequest.const_1191)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_326,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_437 && _loc4_.state != FriendRequest.const_396)
            {
               _loc4_.state = FriendRequest.const_396;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_326,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2072,_loc1_);
         this.setEnabled(this.var_2073,_loc1_);
      }
