package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1175:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1175,param1);
         this.var_946 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_946);
         }
      ...
      {
         return int(this.var_1745 * (Number(param1 - this._minValue) / (this.var_1175 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1745 * (this.var_1175 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_947)
         {
            if(param1.type == WindowMouseEvent.const_54 || param1.type == WindowMouseEvent.const_212)
            {
               this.var_947 = false;
            }
         }
         if(!this.var_947 || param1.type != WindowEvent.const_407)
         {
            return;
         }
         if(this.var_607 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_607) * this.var_607;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_607 != 0)
            {
               _loc3_ = this.var_946 + this.var_607;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_748 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_748.width,this.var_748.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_748,this.var_748.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_747 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_747.width,this.var_747.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_747,this.var_747.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_748 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_747 = BitmapData(_loc2_.content);
      }
   }
}
