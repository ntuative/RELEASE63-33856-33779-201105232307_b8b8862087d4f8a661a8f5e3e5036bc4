package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_84.roomEngine.getRoomObject(this.var_84.roomId,this.var_84.roomCategory,param1,RoomObjectCategoryEnum.const_27);
      }
