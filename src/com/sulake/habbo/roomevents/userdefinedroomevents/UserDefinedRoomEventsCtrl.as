package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_333:int = 3;
      
      private static var var_1539:int = 2;
       
      
      private var var_84:HabboUserDefinedRoomEvents;
      
      private var _window:IFrameWindow;
      
      private var var_53:IWindowContainer;
      
      private var var_1947:TriggerConfs;
      
      private var var_1946:ActionTypes;
      
      private var var_1948:ConditionTypes;
      
      private var var_274:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_802:RoomObjectHightLighter;
      
      private var var_185:UserDefinedRoomEventsHelp;
      
      private var var_1277:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1947 = new TriggerConfs();
         this.var_1946 = new ActionTypes();
         this.var_1948 = new ConditionTypes();
         this.var_274 = new Dictionary();
         super();
         this.var_84 = param1;
         this.var_802 = new RoomObjectHightLighter(param1);
         this.var_185 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_84.getXmlWindow("ude_main"));
         this.var_53 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_53,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_53,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_53,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_53,"apply_snapshot_txt"),this.onApplySnapshot);
         Util.setProcDirectly(this.find(this.var_53,"dec_stuff_sel_txt"),this.onDecStuffSelectionType);
         Util.setProcDirectly(this.find(this.var_53,"inc_stuff_sel_txt"),this.onIncStuffSelectionType);
         this.find(this.var_53,"dec_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_53,"inc_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_53,"helplink").mouseThreshold = 0;
         this.find(this.var_53,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1277 = new SliderWindowController(this.var_84,IWindowContainer(this.find(this.var_53,"delay_slider_container")),this.var_84.assets,0,20,1);
         this.var_1277.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1277.setValue(0);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_84.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_84.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_802.hideAll(this.var_274);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_802.showAll(this.var_274);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1277.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_37.stuffTypeSelectionEnabled)
         {
            ...
            if(_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
            {
               ...
               this.getFurniTypeMatchesText().caption = this.var_84.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
               this.getFurniTypeMatchesCheckBox().visible = true;
               this.getFurniTypeMatchesText().visible = true;
            }
            else if(_loc2_.requiresFurni == var_333)
            {
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_53.findChildByName("select_furni_container"));
         _loc1_.height = Util.getLowestPoint(_loc1_);
      }
      
      private function refreshStuffTypeSelectionToggler() : void
      {
         this.getFurniTypeMatchesText().caption = this.var_84.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_37.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_37 as TriggerDefinition != null)
         {
            this.var_84.send(new UpdateTriggerMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ActionDefinition != null)
         {
            this.var_84.send(new UpdateActionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ConditionDefinition != null)
         {
            this.var_84.send(new UpdateConditionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1277.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_185.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1539) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1539 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_84.send(new ApplySnapshotMessageComposer(this.var_37.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_333)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1948);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         {
            this.find(this.var_53,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_53,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_53,3,5);
         this.var_53.height = Util.getLowestPoint(this.var_53) + 1;
      }
      
      private function getElementName(param1:int) : String
      {
         var _loc2_:IFurnitureData = this.var_84.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_53,"header_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_53,"action_inputs_container"));
         if(this.var_37 as ActionDefinition == null)
         {
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         this.var_84.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_84.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_84.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         this.var_84.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_84.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_84.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      
      private function refreshWarning(param1:String, param2:String) : void
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_53,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_53,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_53.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_53.findChildByName("custom_inputs_container"));
         var _loc4_:String = _loc1_.getKey() + _loc2_.code;
         var _loc5_:IWindowContainer = IWindowContainer(_loc3_.getChildByName(_loc4_));
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_84.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_84);
         }
         return _loc5_;
      }
      ...
      private function refreshSelectFurni() : void
      {
         ...
         this.var_84.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_84.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
      
      private function getFurniTypeMatchesCheckBox() : ICheckBoxWindow
      {
         return ICheckBoxWindow(this.var_53.findChildByName("furni_type_matches_checkbox"));
      }
      
      private function getDecStuffSelTxt() : IWindow
      {
         return this.var_53.findChildByName("dec_stuff_sel_txt");
      }
      
      private function getIncStuffSelTxt() : IWindow
      {
         return this.var_53.findChildByName("inc_stuff_sel_txt");
      }
      
      private function getFurniTypeMatchesText() : IWindow
      {
         return this.var_53.findChildByName("furni_type_matches_txt");
      }
   }
}
