package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1633:String = "sample_44khz";
      
      public static const const_1819:String = "sample_22khz";
      
      public static const const_1718:String = "sample_11khz";
      
      public static const const_1801:String = "sample_16bit";
      
      public static const const_1870:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1099:int = 32;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_171 * this.var_81;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1099)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1099);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_171 == this.var_171 - 1)
            {
               this.var_129[int(_loc11_ / this.var_171)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_129.length * this.var_171 * this.var_81;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_171 * this.var_81;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_695.indexOf(param1) == -1)
         {
