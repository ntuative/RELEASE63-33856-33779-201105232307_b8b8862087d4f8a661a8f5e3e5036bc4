package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1438:int = 60;
      
      private static const const_1437:int = 25165823;
      
      private static const const_1439:int = 16777215;
      ...
      private var var_982:IHabboNotifications;
      
      private var var_981:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         this.var_1228 = new Map();
         this.var_1485 = new ByteArray();
         ...
         events.addEventListener(TraxSongLoadEvent.const_914,this.onTraxLoadComplete);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_982)
         {
            this.var_982.release(new IIDHabboNotifications());
            this.var_982 = null;
         }
         super.dispose();
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_980.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_980.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_981;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_625.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1228.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_260,events);
         _loc5_.volume = this.var_981;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_260.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_982.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_188.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2547 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_982 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_188 == null || this._connection == null || this._roomEngine == null || this.var_227 != null)
         {
            return;
         }
         this.var_227 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_227.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1699,this.var_767));
         this.var_767 = -1;
         this.var_766 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_981 * 100)));
         }
      }
      ...
      {
         this.var_981 = param1;
         this.var_227.updateVolume(this.var_981);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_625.remove(param1);
            if(this.var_260.getValue(_loc2_) == null)
            {
               this.var_1485.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1485,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1485,_loc2_,TraxSample.const_1633,TraxSample.const_1801);
               this.var_260.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1227.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1438 && this.var_1227.length > 0)
            {
               _loc3_ = this.var_1227.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_625.length == 0 && this.var_767 != -1)
            {
               this.var_766.ready = true;
               _loc4_ = this.var_767;
               this.var_767 = -1;
               this.var_766 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_914,_loc4_));
               if(this.var_2547)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_766 == null && this.var_1228.length > 0)
         {
            _loc1_ = this.var_1228.getKey(0);
            _loc2_ = this.var_1228.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_914,_loc1_));
               }
               else
               {
                  this.var_766 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_227.samplesIdsInUse;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_260.length)
         {
            _loc5_ = this.var_260.getKey(_loc4_);
            _loc6_ = this.var_260.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1437)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1439 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_260.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_260.remove(_loc11_);
               }
               this.var_227.samplesUnloaded(_loc7_);
            }
         }
      }
