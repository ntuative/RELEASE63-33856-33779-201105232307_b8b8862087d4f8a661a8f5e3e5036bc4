package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      {
         this.var_227.stop(this.priority);
         this.var_451 = -1;
         this.var_1931 = -1;
         this.var_652 = false;
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_652 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_227.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_129,_loc3_.syncCount / 1000,0,1,1);
            this.var_451 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         {
            this.var_227.addSongInfoRequest(_loc3_.nextSongId);
         }
         this.var_1931 = _loc3_.currentPosition;
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            _loc7_ = this.var_227.getSongInfo(_loc5_) as SongDataEntry;
            if(_loc7_ == null)
            {
               ...
               if(this.var_797.indexOf(_loc5_) < 0)
               {
                  ...
                  this.var_227.requestSongInfoWithoutSamples(_loc5_);
               }
            }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               _loc6_ = this.var_227.getSongInfo(param1.id) as SongDataEntry;
               if(_loc6_ != null)
               {
