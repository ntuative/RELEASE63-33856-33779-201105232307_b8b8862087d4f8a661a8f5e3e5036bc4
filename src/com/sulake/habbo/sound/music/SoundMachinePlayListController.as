package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_227:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_910,this.onSoundMachinePlayEvent);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_801,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_84)
            {
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_910,this.onSoundMachinePlayEvent);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_801,this.onSoundMachineStopEvent);
               this.var_84 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_451);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_227.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_451 = -1;
         this.var_652 = false;
         this.var_227.stop(HabboMusicPrioritiesEnum.const_129);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_227.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_227.playSong(param1,HabboMusicPrioritiesEnum.const_129,_loc3_,0,0,0))
         {
