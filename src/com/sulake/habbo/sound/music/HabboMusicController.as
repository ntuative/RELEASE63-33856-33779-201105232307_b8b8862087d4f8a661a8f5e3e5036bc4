package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1406:int = HabboMusicPrioritiesEnum.const_129;
      ...
      private var var_84:IEventDispatcher;
      ...
      private var var_503:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_777,this.onJukeboxInit);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_233,this.onJukeboxDispose);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_975,this.onSoundMachineInit);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_918,this.onSoundMachineDispose);
         this.var_1160 = new Timer(1000);
         this.var_1160.start();
         this.var_1160.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_250)
         {
            this.var_296[_loc6_] = null;
            this.var_745[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1742)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_429)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_251)
            {
               ...
               {
                  _loc3_ = this.var_251.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_84)
            {
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_777,this.onJukeboxInit);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_233,this.onJukeboxDispose);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_975,this.onSoundMachineInit);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_918,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_296[param1];
      ...
      {
         var _loc1_:int = this.var_296.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_296[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_251.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_250)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_600.add(param1,param2);
            this.var_744.push(param1);
         }
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_357.length)
         {
            return this.var_357.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_357.length)
         {
            return this.var_357.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_251.length)
         {
            ...
            if(_loc3_.id != this.var_1435 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_296[_loc2_] != null)
            {
               _loc3_ = this.var_296[_loc2_];
               _loc4_ = this.var_251.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_744));
         Logger.log("Requested song info\'s : " + this.var_744);
         this.var_744 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_251.add(_loc6_.id,_loc10_);
               ...
               while(this.var_743.indexOf(_loc6_.id) != -1)
               {
                  this.var_743.splice(this.var_743.indexOf(_loc6_.id),1);
                  if(this.var_743.length == 0)
                  {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_250)
         {
            return false;
         }
         ...
         this.var_1742 = this.getSongRequestCountAtPriority(param1);
         this.var_1435 = param2;
         if(this._priorityPlaying <= const_1406)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2357 != param1.id || _loc3_ > this.var_2356 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2357 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_503 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_84,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_503 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
