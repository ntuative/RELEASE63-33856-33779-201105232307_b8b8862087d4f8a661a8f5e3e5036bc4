package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1495:uint = 13232628;
      
      private static var var_1867:uint = 11129827;
      ...
      private var var_1869:IWindowContainer;
      ...
      private var var_1235:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1869 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_773)
         {
            this.var_773 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_773)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_774)
         {
            this.var_774 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_774)
            {
               return;
            }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_519);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1082 || param1 == ChangeUserNameResultMessageEvent.var_1083)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1235 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1235.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1495;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1494)
         {
            if(param1.type == WindowEvent.const_106)
            {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_519 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_519 != _loc5_)
               {
                  this.var_1868 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_519);
               break;
