package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_394:String = "TUI_CLOTHES_VIEW";
      ...
      private var var_356:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_569,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_600,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_484,this.onTaskDoneEvent);
         if(this.var_34.sessionDataManager != null)
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_357,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1153 && this.var_1152 && this.var_1430;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_569,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_600,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_484,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_357,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_569:
               this.var_1430 = true;
               if(this.var_45 != null && this.var_45.id == const_551)
               {
                  this.showView(const_96);
               }
               break;
            case HabboHelpTutorialEvent.const_600:
               if(this.var_45 != null && this.var_45.id == const_394)
               {
                  this.var_1723 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2327 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_349:
               ...
               if(this.var_356 == null)
               {
                  this.var_356 = new NameChangeView(this);
               }
               this.var_356.showMainView();
               this.prepareForTutorial();
               break;
            case const_394:
         ...
         this._window.height = _loc2_.height + this.var_2325;
         this._window.width = _loc2_.width + this.var_2327;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_34.hideUI();
         this.var_34.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_133));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_45 != null && (this.var_45.id == const_349 || this.var_45.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      {
         this.var_1153 = true;
         if(this.var_45 != null && (this.var_45.id == const_394 || this.var_45.id == const_96))
         {
            this.showView(const_96);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_566)
         {
            this.var_1152 = true;
         ...
         {
            this.var_356.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_566)
         {
            this.var_356.checkedName = _loc2_.name;
         }
         else
         {
            this.var_356.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
