package com.sulake.habbo.help.help.data
{
   ...
   public class FaqCategory
   {
      ...
      public function storeItem(param1:int, param2:String, param3:String = null) : void
      {
         ...
         if(_loc4_ == null)
         {
            _loc4_ = new FaqItem(param1,param2,this.var_163.length,this);
            this.var_163.add(param1,_loc4_);
         }
      }
      ...
      {
         if(param1 >= this.var_163.length)
         {
            return null;
         }
         return this.var_163.getWithIndex(param1);
      }
      ...
      {
         return this.var_163.getValue(param1) != null;
      }
      
      public function getItem(param1:int) : FaqItem
      {
         return this.var_163.getValue(param1);
      }
      ...
      public function getQuestionTitleArray() : Array
      {
         ...
         {
            _loc2_ = this.var_163.getWithIndex(_loc3_);
      ...
      {
         return this.var_163.length > 0 || this.hasUpdatedWithinHour();
      }
      
      public function setTimeStamp() : void
      {
         this.var_1848 = new Date();
      }
      ...
      public function getAgeSeconds() : Number
      {
         ...
         return (new Date().valueOf() - this.var_1848.valueOf()) / 1000;
      }
