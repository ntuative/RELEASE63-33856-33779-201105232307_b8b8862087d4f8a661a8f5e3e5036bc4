package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_2462:WelcomeNotification;
      ...
      public function dispose() : void
      {
         if(this.var_185)
         {
            this.var_185.removeUpdateReceiver(this);
            this.var_185.toolbar.events.removeEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
            this.var_185 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_185.toolbar.events.addEventListener(HabboToolbarEvent.const_48,this.onToolbarClicked);
         if(this._window == null)
         {
            this.initializeWindow();
         }
         var _loc2_:ITextWindow = ITextWindow(this._window.findChildByName("text"));
         _loc2_.caption = this.var_185.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_214.y = this.var_185.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_185.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_185.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_311,false);
         _loc4_.height -= 20;
      ...
      {
         this.var_185.removeUpdateReceiver(this);
         this.var_185.registerUpdateReceiver(this,10);
      }
   }
}
