package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1230:IRoomWidgetFactory;
      ...
      private var var_1855:IHabboAvatarEditor = null;
      ...
      private var var_1192:IHabboHelp;
      
      private var var_983:IHabboModeration;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1192.release(new IIDHabboHelp());
            this.var_1192 = null;
         }
         ...
         {
            this.var_983.release(new IIDHabboModeration());
            this.var_983 = null;
         }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1855 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_302.events.addEventListener(AdEvent.const_582,this.adEventHandler);
            this.var_302.events.addEventListener(AdEvent.const_584,this.adEventHandler);
            this.var_302.events.addEventListener(AdEvent.const_602,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1192 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_983 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_983);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            this.var_16.events.addEventListener(RoomSessionEvent.const_276,this.roomSessionStateEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionUserBadgesEvent.const_150,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPresentEvent.const_358,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_512,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_635,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_572,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_579,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_294,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_241,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_749,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1266,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1281,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_847,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_789,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_958,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_528,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionVoteEvent.const_166,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionVoteEvent.const_168,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_539,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionFriendRequestEvent.const_162,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserNotificationEvent.const_118,this.roomSessionEventHandler);
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_276:
               this.createDesktop(param1.session);
               break;
            case RoomSessionEvent.const_86:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_938);
               break;
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_241:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_749:
            ...
            case RoomSessionErrorMessageEvent.const_280:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_847:
               errorMessage = "${room.error.pets.forbidden_in_hotel}";
               break;
            case RoomSessionErrorMessageEvent.const_737:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_789:
               errorMessage = "${room.error.pets.no_free_tiles}";
               break;
            case RoomSessionErrorMessageEvent.const_958:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_856,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_344,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_328,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_613,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_279,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_870,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_634,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_589,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_233,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_856)
         {
            if(this.var_16 != null)
            {
               this.var_16.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_511 || param1.type == RoomEngineEvent.const_613)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_344:
               _loc5_ = false;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_688);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_832);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_385);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1486 != RoomDesktop.const_545)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_306,this.var_1486);
               }
               if(this.var_302 != null)
               {
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1230;
         ...
         _loc3_.avatarEditor = this.var_1855;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_302;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1192;
         _loc3_.moderation = this.var_983;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_306);
            if(_loc3_ != RoomDesktop.const_545)
            {
               this.var_1486 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
