package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1456:IMessageEvent;
      
      private var var_1802:IMessageEvent;
      
      private var var_1801:IMessageEvent;
      ...
      {
         this.var_1456 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1802 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1801 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1456);
         this._connection.addMessageEvent(this.var_1802);
         this._connection.addMessageEvent(this.var_1801);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1456);
               this._connection.removeMessageEvent(this.var_1802);
               this._connection.removeMessageEvent(this.var_1801);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_898,RoomWidgetPlayListModificationMessage.const_880,RoomWidgetPlayListModificationMessage.const_909,RoomWidgetPlayListPlayStateMessage.const_818,RoomWidgetPlayListUserActionMessage.const_701];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_898:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_816,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_880:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_909:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_818:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_701:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_233);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_233:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_702,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_911,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_881));
               break;
