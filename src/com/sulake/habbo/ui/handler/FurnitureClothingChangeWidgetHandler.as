package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1467:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1466:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         var _loc2_:RoomWidgetClothingChangeUpdateEvent = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_432);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_753,RoomWidgetClothingChangeMessage.const_422,RoomWidgetAvatarEditorMessage.const_392];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_753:
            ...
            case RoomWidgetClothingChangeMessage.const_422:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1215);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1467;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1122);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1466;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_248,AvatarEditorFigureCategory.const_776],true))
                     {
                        _loc11_ = 0;
            ...
            case RoomWidgetAvatarEditorMessage.const_392:
               _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_432);
               this._container.events.dispatchEvent(_loc5_);
         }
         return null;
      }
