package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_757);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_941);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_865);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_757:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_941:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_865:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_162);
         _loc1_.push(FriendRequestEvent.const_62);
         _loc1_.push(FriendRequestEvent.const_326);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_162:
            ...
            case FriendRequestEvent.const_326:
