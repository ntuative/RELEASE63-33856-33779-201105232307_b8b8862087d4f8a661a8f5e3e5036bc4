package com.sulake.habbo.ui.handler
{
   ...
   public class VoteWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionVoteEvent.const_168);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionVoteEvent.const_166:
               ...
               break;
            case RoomSessionVoteEvent.const_168:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_168,_loc2_.question,_loc2_.choices,_loc2_.votes,_loc2_.totalVotes);
         }
         if(_loc3_ == null)
         {
            return;
