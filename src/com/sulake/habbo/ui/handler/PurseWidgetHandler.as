   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this._container.catalog.events.removeEventListener(PurseEvent.const_111,this.purseEventHandler);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         if(this._container.catalog)
         {
            ...
            this._container.catalog.events.addEventListener(PurseEvent.const_111,this.purseEventHandler);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_963);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_963:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_111,_loc2_.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
               break;
            case RoomWidgetOpenCatalogMessage.const_382:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1293:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1659);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1298:
      ...
      private function purseEventHandler(param1:PurseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case PurseEvent.const_69:
               ...
               break;
            case PurseEvent.const_111:
               _loc2_ = new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_111,param1.balance);
         }
         if(_loc2_)
         {
