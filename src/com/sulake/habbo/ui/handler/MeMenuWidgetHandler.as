package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      private var var_1881:BitmapData;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_357,this.onFigureUpdate);
            }
            if(this.var_13 && !this.var_13.disposed && this.var_13.events)
            {
               this.var_13.events.removeEventListener(HabboInventoryEffectsEvent.const_706,this.onAvatarEffectsChanged);
               this.var_13.events.removeEventListener(HabboInventoryHabboClubEvent.const_792,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_716,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_357,this.onFigureUpdate);
         }
         this.var_13 = this._container.inventory;
         if(this.var_13 != null)
         {
            this.var_13.events.addEventListener(HabboInventoryEffectsEvent.const_706,this.onAvatarEffectsChanged);
            this.var_13.events.addEventListener(HabboInventoryHabboClubEvent.const_792,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_716,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1510)
            {
               ...
               this.var_1510 = _loc3_;
               this.var_1881 = _loc1_;
               this.var_1882 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1881;
               _loc2_ = this.var_1882;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_457)
               {
                  ...
                  if(_loc2_.height > const_457 - const_1056)
                  {
                     _loc8_.offset(0,_loc2_.height - const_457 + const_1056);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_899);
         _loc1_.push(RoomWidgetDanceMessage.const_778);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_890);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_893);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_725);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_767);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_786);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_382);
         _loc1_.push(RoomWidgetStopEffectMessage.const_908);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1917);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1280);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_392);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1863);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1233);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_809);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_964);
         _loc1_.push(RoomWidgetMeMenuMessage.const_820);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_945);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1810);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_970);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_713);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_682);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_422);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_964:
               ...
               break;
            case RoomWidgetWaveMessage.const_899:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_778:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_890:
               if(this.var_13 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_893:
               if(this.var_13 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_725:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_382:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1125)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_192,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_786:
               ...
               if(this.var_13 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1129:
                        this._catalog.openCatalogPage(CatalogPageName.const_1724,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1288:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1645:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1684:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_908:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1280:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_809:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_820:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_392:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_600));
                  }
               }
               break;
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_931));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_716:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_627));
         }
      }
