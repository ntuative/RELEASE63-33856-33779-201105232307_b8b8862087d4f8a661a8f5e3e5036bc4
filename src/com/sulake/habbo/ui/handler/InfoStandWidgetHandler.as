package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_227.events.addEventListener(NowPlayingEvent.const_101,this.onNowPlayingChanged);
            this.var_227.events.addEventListener(SongInfoReceivedEvent.const_90,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_112,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_112,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_612.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_612.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_227 != null)
         {
            this.var_227.events.removeEventListener(NowPlayingEvent.const_101,this.onNowPlayingChanged);
            this.var_227.events.removeEventListener(SongInfoReceivedEvent.const_90,this.onSongInfoReceivedEvent);
            this.var_227 = null;
         }
         this.var_1092 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_546);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_694);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_717);
         _loc1_.push(RoomWidgetFurniActionMessage.const_980);
         _loc1_.push(RoomWidgetFurniActionMessage.const_972);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1110);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_709);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_747);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_987);
         _loc1_.push(RoomWidgetUserActionMessage.const_478);
         _loc1_.push(RoomWidgetUserActionMessage.const_601);
         _loc1_.push(RoomWidgetUserActionMessage.const_595);
         _loc1_.push(RoomWidgetUserActionMessage.const_1657);
         _loc1_.push(RoomWidgetPetCommandMessage.const_501);
         _loc1_.push(RoomWidgetPetCommandMessage.const_768);
         _loc1_.push(RoomWidgetUserActionMessage.const_527);
         _loc1_.push(RoomWidgetUserActionMessage.const_372);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_742);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_478)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_372 || param1.type == RoomWidgetUserActionMessage.const_527 || param1.type == RoomWidgetUserActionMessage.const_595)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_546:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_694:
            ...
            case RoomWidgetUserActionMessage.const_467:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1179,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_595:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_717:
            ...
            case RoomWidgetFurniActionMessage.const_277:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_980:
            ...
            case RoomWidgetFurniActionMessage.const_972:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1110:
            ...
            case RoomWidgetRoomTagSearchMessage.const_709:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_747:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_987:
               ...
               break;
            case RoomWidgetUserActionMessage.const_478:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_263);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_315);
               _loc6_.id = param1.id;
               ...
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_853) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1120;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_263);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1131);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1150);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_543)
                  {
                     _loc30_ = this.var_227.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_419) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_419.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_227.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_213)
               {
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_629)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_576);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_119)
               {
                  _loc14_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_140)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_699);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_943;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_825;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1809);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_150];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_150:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_612.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_612.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_227 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_227.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_403,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_227 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_427,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
