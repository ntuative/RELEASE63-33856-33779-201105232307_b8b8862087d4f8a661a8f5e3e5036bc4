package com.sulake.habbo.ui.handler
{
   ...
   public class SpamWallPostItWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1814:IMessageEvent;
      ...
      {
         this.var_1814 = new RequestSpamWallPostItMessageEvent(this.onSpamWallPostItRequest);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1814);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this._disposed = true;
            this._connection.removeMessageEvent(this.var_1814);
      ...
      private function onSpamWallPostItRequest(param1:RequestSpamWallPostItMessageEvent) : void
      {
         ...
         {
            _loc6_ = this._container.inventory.getItemById(FurniModelCategory.const_42,_loc3_);
         }
         ...
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetSpamWallPostItEditEvent(RoomWidgetSpamWallPostItEditEvent.const_506,_loc3_,_loc4_,_loc5_));
            }
         }
      }
      ...
      {
         return [RoomWidgetSpamWallPostItEditEvent.const_506,RoomWidgetSpamWallPostItFinishEditingMessage.const_923];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetSpamWallPostItFinishEditingMessage.const_923:
