package com.sulake.habbo.ui.handler
{
   ...
   public class UserChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_306;
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_391);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.REQUEST_USER_CHOOSER:
               ...
               break;
            case RoomWidgetRoomObjectMessage.const_391:
      ...
      private function handleUserChooserRequest() : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_830,_loc3_));
      }
