package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_739:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_426 != null)
         {
            ...
            {
               _loc2_ = this.var_426.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_295 != null)
         {
            ...
            {
               _loc2_ = this.var_295.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_936,RoomWidgetChatSelectAvatarMessage.const_752];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_936:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1190))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1190))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_752:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_213)
                           {
                              _loc13_ = this.var_295.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_426.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_596.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_213:
                                       _loc13_ = this.getPetImage(_loc16_);
                                       _loc12_ = uint(this.var_596.getValue(_loc16_));
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_98,null,this);
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_596.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_213)
                                    {
                                       this.var_295.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_426.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1149 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1149);
            }
            if(this.var_739 == null)
            {
               ...
               this.var_500.y = 0;
               this.var_500.z = 0;
               this.var_739 = _loc4_.getScreenPoint(this.var_500);
               this.var_1149 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_500.x = 0;
            this.var_500.y = 0;
            this.var_500.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_500);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_739.x || _loc8_.y != this.var_739.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_739,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_295)
         {
            _loc2_ = this.var_295.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1148.push(_loc2_);
            }
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_426)
         {
            _loc2_ = this.var_426.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1148.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_98,this);
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_596.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1717.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1717.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_295)
            {
               this.var_295.add(_loc3_,param2);
            }
         }
      }
   }
