package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_889,RoomWidgetEcotronBoxOpenMessage.const_916,RoomWidgetEcotronBoxOpenedMessage.const_1676];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_889:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_916:
