package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_691:String = "MISV_BUY_MORE";
      
      public static const const_704:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_2071:ITextWindow;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_438[param1] as IWindowContainer,0);
         this.var_45 = param1;
      }
      ...
      {
         this.blitBackgroundImage(const_704,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_691,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_704,_loc1_);
            this.var_2071 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2070 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_537));
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_691,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_514));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_438[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
