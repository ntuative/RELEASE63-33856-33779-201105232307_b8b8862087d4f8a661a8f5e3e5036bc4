package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_1216:String = "PLSV_START_PLAYBACK";
      
      public static const const_526:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_45 != const_526)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_438[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_438[const_872];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_438.add(const_526,_loc1_);
