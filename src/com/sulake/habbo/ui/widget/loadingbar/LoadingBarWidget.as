package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_488:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_488.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_488 = null;
         }
         if(this.var_47 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_318,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_318,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_488 == null)
         {
            this.var_488 = new Sprite();
            this.var_488.addChild(new Bitmap(this.var_47));
            this.var_488.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_488.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_47;
            }
         }
         _loc2_.setDisplayObject(this.var_488);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_318)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1311 != "")
         {
            HabboWebTools.openWebPage(this.var_1311);
         }
      }
   }
}
