package com.sulake.habbo.ui.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_1938:int = 3;
      
      private const const_2204:uint = 4.291993382E9;
      
      private const const_2206:uint = 4.29080704E9;
      
      private const const_2205:uint = 4.285767869E9;
      
      private const const_2207:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         if(_loc5_)
         {
            ...
            this._view.x = _loc6_.width - this._view.width - this.const_1938;
            this._view.y = this.const_1938;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPurseUpdateEvent.const_111,this.onPixelBalance);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPurseUpdateEvent.const_111,this.onPixelBalance);
      }
      
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1688 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1688.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1688.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1687 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1687.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1687.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1298));
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1293));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2206;
      }
      
      private function onOrangeMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2204;
      }
      
      private function onBlueMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2207;
      }
      
      private function onBlueMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2205;
      }
   }
}
