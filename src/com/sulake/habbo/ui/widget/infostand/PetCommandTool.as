package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private static const const_1477:Point = new Point(100,30);
      ...
      private const const_2232:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_375 = new Timer(this.const_2232);
         this.var_375.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1251.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_525);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1251.getValue(this.var_525) as CommandConfiguration;
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_768,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40.setParamFlag(WindowParam.const_100,true);
         this.var_40.context.getDesktopWindow().addEventListener(WindowEvent.const_40,this.onWindowDesktopResized);
         this.var_40.procedure = this.onCommandWindowProcedure;
         this.var_40.position = const_1477;
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_372,this.var_525));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_501,this.var_525,this.var_1884 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_501,this.var_525,this.var_1884 + " " + _loc5_);
