package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         super.update(param1);
         this.var_1753 = this.getSongIdFromExtraParam(param1.extraParam);
      }
      
      public function updateSongInfo(param1:RoomWidgetSongUpdateEvent) : void
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_427 && param1.songId == this.var_1753)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         if(var_46 != null)
         {
            var_51 = var_46.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_419.length,param1.length);
