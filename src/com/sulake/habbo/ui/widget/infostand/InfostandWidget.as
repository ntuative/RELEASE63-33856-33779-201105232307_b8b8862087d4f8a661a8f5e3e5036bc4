package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1970:String = "infostand_user_view";
      
      private const const_1971:String = "infostand_furni_view";
      
      private const const_1966:String = "infostand_pet_view";
      
      private const const_1967:String = "infostand_bot_view";
      
      private const const_1968:String = "infostand_jukebox_view";
      
      private const const_1969:String = "infostand_songdisk_view";
      ...
      private var var_465:InfoStandBotView;
      ...
      private var var_685:InfostandFurniData;
      ...
      private const const_2242:int = 3000;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1289 = new InfoStandFurniView(this,this.const_1971,this._catalog);
         this.var_191 = new InfoStandUserView(this,this.const_1970);
         this.var_388 = new InfoStandPetView(this,this.const_1966,this._catalog);
         this.var_465 = new InfoStandBotView(this,this.const_1967);
         this.var_1039 = new InfoStandJukeboxView(this,this.const_1968,this._catalog);
         this.var_1040 = new InfoStandSongDiskView(this,this.const_1969,this._catalog);
         this.var_1564 = new InfostandUserData();
         this.var_685 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_170 = new Timer(this.const_2242);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_77,HabboWindowStyle.const_47,HabboWindowParam.const_47,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_948,this.onRoomObjectSelected);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_315,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_864,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_948,this.onRoomObjectSelected);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_315,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_864,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_372,this.var_388.getCurrentPetId()));
      }
      ...
      {
         this.userData.setData(param1);
         this.var_465.update(param1);
         this.selectView(this.const_1967);
         if(this.var_170)
         {
            this.var_170.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_543)
         {
            this.var_1039.update(param1);
            this.selectView(this.const_1968);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_419) != -1)
         {
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1966);
         if(this.var_170)
         {
            this.var_170.start();
         }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_191.setTags(param1.tags,this.var_2786);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_465.image = param1.image;
         }
         else
         {
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_465.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_154:
               _loc2_ = param1.id == this.var_685.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_180:
               ...
               if(this.var_465 != null && this.var_465.window != null && this.var_465.window.visible)
               {
                  _loc2_ = param1.id == this.var_1564.userRoomId;
                  break;
               }
