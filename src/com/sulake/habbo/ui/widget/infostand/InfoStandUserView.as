package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_138:IBorderWindow;
      
      private var var_2436:int;
      
      private var var_2435:Boolean = true;
      
      private const const_1028:int = 5;
      
      private const const_2212:int = 3;
      
      private const const_1410:int = 11184810;
      
      private const const_1409:int = 16777215;
      
      private const const_2214:int = 2000;
      
      private const const_2213:int = 50;
      
      private const const_2215:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_905 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2435 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_138.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_138.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_138.x = _loc5_.left - this.var_138.width;
         this.var_138.y = _loc5_.top + (_loc5_.height - this.var_138.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_138.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_138.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_138.x = _loc7_.left - this.var_138.width;
         this.var_138.y = _loc7_.top + (_loc7_.height - this.var_138.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_138 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_138 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1028;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         var _loc6_:IWindowContainer = this.var_51.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1410;
            }
            else
            {
               _loc5_.textColor = this.const_1409;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1028,this.const_2213);
         _loc5_.height = Math.max(_loc5_.height,this.const_2215);
         _loc3_.height = _loc5_.height + this.const_2212;
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_905.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_943:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2436 > this.const_2214 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2436 = _loc6_;
               _loc3_.textColor = this.const_1409;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1410;
         }
      }
