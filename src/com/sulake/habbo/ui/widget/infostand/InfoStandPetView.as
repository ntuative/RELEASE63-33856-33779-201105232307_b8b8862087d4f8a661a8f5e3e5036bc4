package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1516:int = 152;
      
      private static const const_1518:int = 16;
      
      private static const const_668:int = 4;
      
      private static const const_1515:uint = 14342874;
      
      private static const const_1513:uint = 3815994;
      
      private static const const_1510:uint = 2085362;
      
      private static const const_1514:uint = 39616;
      
      private static const const_1522:uint = 10513106;
      
      private static const const_1520:uint = 8734654;
      
      private static const const_1511:uint = 9094430;
      
      private static const const_1509:uint = 6200576;
      
      private static const const_1521:String = "happiness";
      
      private static const const_1517:String = "experience";
      
      private static const const_1519:String = "energy";
      
      private static const const_1512:int = 250;
      
      private static const const_1077:int = 25;
      ...
      private var var_209:PetCommandTool;
      ...
      {
         if(this.var_51 == null || this.var_46 == null || this.var_100 == null)
         {
            return;
         }
         this.var_100.width = this.var_100.width;
         this.var_100.visible = this.var_100.width > 0;
         this.var_51.height = this.var_51.scrollableRegion.height;
         this.var_46.height = this.var_51.height + 20;
         this._window.width = Math.max(this.var_46.width,this.var_100.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_46.width < this.var_100.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1521,param1.nutrition,param1.nutritionMax,const_1514,const_1510);
         this.updateStateElement(const_1517,param1.experience,param1.experienceMax,const_1520,const_1522);
         this.updateStateElement(const_1519,param1.energy,param1.energyMax,const_1509,const_1511);
         ...
         this.updateWindow();
         this.var_525 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_209 && this.var_209.isVisible() && param1.isOwnPet)
         {
            this.var_209.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_209.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1516,const_1518,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1515);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1513);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_668,_loc7_.width - 2,_loc7_.height - 2 - const_668);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_668);
      ...
      private function openTrainView() : void
      {
         if(this.var_209 == null)
         {
            this.var_209 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_525) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_209.showWindow(true);
            this.var_209.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this.var_46 != null)
         {
            this.var_51 = this.var_46.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc4_:* = [];
         this.var_100.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_209 && this.var_209.getPetId() == this.var_525)
               {
                  this.var_209.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_426,this._widget.petData.ownerId);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:int = const_1512;
         this.var_100.width = _loc1_;
         var _loc2_:* = [];
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1077 + const_1078;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1078;
            }
         }
         this.var_100.height = _loc4_ + const_1077;
         this.updateWindow();
      }
   }
}
