package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      {
         if(this.var_51 == null || this.var_46 == null || this._buttons == null)
         {
            return;
         }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1120 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_543 && param1.isRoomOwner)
         {
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1307.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_51.addListItem(this.var_241);
            }
            this.var_241.visible = param1;
         }
         else
         {
            this.var_51.removeListItem(this.var_241);
         }
      }
   }
}
