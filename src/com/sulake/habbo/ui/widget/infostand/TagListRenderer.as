package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2218:int = 5;
      
      private const const_2219:int = 5;
      ...
      private var var_1195:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1194 = 0;
         this.var_1195 = param2.rectangle.clone();
         this.var_1195.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1195.width)
         {
            return false;
         }
         if(this.var_1194 + param1.height > this.var_1195.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1195.width)
         {
            this._offsetX = 0;
            this.var_1194 += param1.height + this.const_2219;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1194);
         this._offsetX += param1.width + this.const_2218;
         return true;
      }
