package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1359:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_177.state = RoomChatHistoryPulldown.const_273;
         ...
         this.var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_1236,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_177.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_273);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_177.state == RoomChatHistoryPulldown.const_442 || this.var_177.state == RoomChatHistoryPulldown.const_604;
      }
      ...
      {
         if(!this.var_411 && !this.var_1669)
         {
            this.var_411 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_177.state = RoomChatHistoryPulldown.const_442;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_50 != null)
         {
            ...
            if(param2)
            {
               this.var_50.scrollV = this.var_581;
            }
         }
         if(this.var_177 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_412 > 0 && param2)
         {
            if(this.var_1658)
            {
               if(Math.abs(param1 - this.var_412) <= const_1184)
               {
                  return;
               }
               this.var_1658 = false;
            ...
            if(this.var_411)
            {
               ...
               _loc5_ = (param1 - this.var_412) / this.var_50.height;
               _loc3_ = this.var_581 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_412;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_50.scrollV < 1 - const_1359 / this.var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1657)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_50 != null)
         {
            this.var_581 = this.var_50.scrollV;
         }
         if(this.var_50 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_581 - this.var_50.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
