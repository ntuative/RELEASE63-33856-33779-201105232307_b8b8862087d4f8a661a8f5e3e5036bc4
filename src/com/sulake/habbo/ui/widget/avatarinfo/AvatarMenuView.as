package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1342:uint = 0;
      
      protected static const const_363:uint = 1;
      
      protected static const const_990:uint = 2;
      
      protected static var var_1365:uint = const_363;
      
      private static const const_1589:uint = 4281149991;
      
      private static const const_1593:uint = 4283715916;
      
      private static const const_1594:uint = 16777215;
      
      private static const const_1591:uint = 9552639;
      
      private static const const_1592:uint = 16744755;
      
      private static const const_1590:uint = 16756591;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1364)
         {
            ...
            {
               this.var_337 = const_990;
            }
            else
            {
               this.var_337 = var_1365;
            }
         }
         if(this.var_337 == const_1342)
         {
         ...
         if(this.var_337 == const_1342 || this.var_337 == const_363)
         {
            ...
            else
            {
               ...
               this.var_337 = const_363;
            }
         }
         if(this.var_337 == const_363)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == "button")
            {
               param2.color = const_1589;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1594;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1592;
               }
            }
         }
         if(_loc3_)
