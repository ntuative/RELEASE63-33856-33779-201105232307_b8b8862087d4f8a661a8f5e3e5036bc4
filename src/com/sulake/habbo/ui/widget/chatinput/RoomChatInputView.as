package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_1918:IWindow;
      
      private var _button:IWindow;
      
      private var var_1919:IWindow;
      
      private var var_1523:IWindow;
      ...
      private const const_2238:int = 250;
      
      private const const_2236:int = 0;
      
      private const const_2237:String = "${widgets.chatinput.say}";
      
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1267 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2659 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2658 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_382 = new Timer(1000,1);
         this.var_382.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_449 = new Timer(10000,1);
         this.var_449.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_382.reset();
            this.var_382.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_382 = null;
         }
         if(this.var_449 != null)
         {
            this.var_449.reset();
            this.var_449.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_449 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1918 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1919 = this._window.findChildByName("send_button_text");
         this.var_1523 = this._window.findChildByName("block_text");
         this.var_1919.caption = this.const_2237;
         this.var_25.setParamFlag(HabboWindowParam.const_45,true);
         this.var_25.addEventListener(WindowMouseEvent.const_43,this.windowMouseEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_207,this.windowKeyEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_342,this.keyUpHandler);
         this.var_25.addEventListener(WindowEvent.const_106,this.onInputChanged);
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1918.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2238 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),this.const_2236);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_25 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1267 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_25.text = "";
                  this.var_646 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_646.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_647);
