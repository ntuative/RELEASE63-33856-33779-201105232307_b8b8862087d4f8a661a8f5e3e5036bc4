package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1077:MeMenuSoundSettingsSlider;
      
      private var var_1076:BitmapData;
      
      private var var_1074:BitmapData;
      ...
      {
         this.var_981 = param1.volume;
         if(this.var_1077 != null)
         {
            this.var_1077.setValue(this.var_981);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1074 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1075 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_1077 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_981 == 0)
         {
            ...
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1076);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1075);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1074);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_970);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_713);
         }
