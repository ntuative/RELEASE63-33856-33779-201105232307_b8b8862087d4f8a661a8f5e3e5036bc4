package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2208:int = 1000;
      ...
      {
         super();
         this.var_216 = new Timer(this.const_2208);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_179.isActive)
         {
            ...
            this.var_925.width = _loc2_ * this.var_307;
         }
         else
         {
            this.var_925.width = 0;
            this.var_216.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_738 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_738 == null)
            {
               return;
            }
         ...
         if(!this.var_179.isActive)
         {
            this.var_738.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_738.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_738.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.setTimeLeft();
         this.var_925 = this._window.findChildByName("loader_bar");
         if(this.var_925 != null)
         {
            this.var_307 = this.var_925.width;
            this.var_216.start();
            this.onUpdate();
         }
