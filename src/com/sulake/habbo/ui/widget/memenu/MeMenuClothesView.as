package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_682));
         }
         this._widget = null;
         if(this._window)
         {
            this._window.removeEventListener(WindowEvent.const_134,this.onViewChange);
            this._window.removeEventListener(WindowEvent.const_338,this.onViewChange);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_134,this.onViewChange);
         this._window.addEventListener(WindowEvent.const_338,this.onViewChange);
         this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_392,this._window));
      }
