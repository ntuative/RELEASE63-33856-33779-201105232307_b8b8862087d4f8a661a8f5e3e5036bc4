package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class UserChooserWidget extends ChooserWidgetBase
   {
      ...
      private const const_2244:int = 0;
      
      private const const_1976:int = 1;
      ...
      override public function get state() : int
      {
         ...
         {
            return this.const_1976;
         }
         return this.const_2244;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_787,this.onUpdateUserChooser);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_787,this.onUpdateUserChooser);
      }
