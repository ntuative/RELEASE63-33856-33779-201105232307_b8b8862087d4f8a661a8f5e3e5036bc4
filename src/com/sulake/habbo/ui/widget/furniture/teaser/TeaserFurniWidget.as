package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1961:int = 0;
      
      private const const_1958:int = 1;
      
      private const const_1959:int = 2;
      
      private const const_1962:int = 3;
      
      private const const_1960:int = 4;
      
      private const const_2224:int = 0;
      
      private const const_2226:int = 1;
      
      private const const_2222:int = 2;
      
      private const const_2229:int = 3;
      
      private const const_2230:int = 4;
      
      private const const_2228:int = 5;
      
      private const const_1957:String = "deco_img";
      
      private const const_1963:String = "dialog_bg";
      
      private const const_2225:String = "%campaign%_dialog_bg.png";
      
      private const const_366:String = "%campaign%_gift_package.png";
      
      private const const_2223:String = "%campaign%_gift_content.png";
      
      private const const_2227:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1509 = this.var_133.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1509 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1506.length)
         {
            _loc2_ = this.var_1506.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_133 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_841,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_488:
               _loc2_ = this.const_1961;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_841:
               ...
               this._shareId = null;
               this.var_1507 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1508 != _loc2_ || _loc3_ != this.var_186))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_186 = _loc3_;
         this.var_1508 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1508)
            {
               ...
               case this.const_1958:
                  if(this.var_408 == this.const_2224)
                  {
                  ...
                  else if(this.var_408 == this.const_2226)
                  {
                     ...
                     _loc2_ = this.const_2223;
                  }
                  else if(this.var_408 == this.const_2222)
                  {
                  ...
                  else if(this.var_408 == this.const_2228)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2225.replace("%campaign%",this.var_186);
            this.setDecoImage(_loc5_,this.const_1963);
            _loc2_ = _loc2_.replace("%campaign%",this.var_186);
            this.setDecoImage(_loc2_,this.const_1957);
            if(_loc3_)
            {
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1507 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1507 == 1 ? "null" : InventoryCategory.const_132);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_848,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1506.push(new ImageDownloader(this,_assets,this.var_186,this.var_1509,param1,param2));
            return;
         }
