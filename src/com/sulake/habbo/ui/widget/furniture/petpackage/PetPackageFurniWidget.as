package com.sulake.habbo.ui.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_631,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_631,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_597:
               this.hideInterface();
               this.var_218 = event.objectId;
               this.var_620 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_631:
               if(!this.var_1220)
               {
                  return;
               }
            ...
            case RoomWidgetPetPackageUpdateEvent.const_420:
               if(event.objectId != this.var_218)
               {
                  return;
               }
               this.var_620 = event.image;
      ...
      {
         var _loc2_:* = null;
         if(this.var_620 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_620.width) / 2,(_loc1_.height - this.var_620.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_620,this.var_620.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1220 || this.var_218 == -1)
         {
            return;
         }
         ...
         {
            this.var_1220 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_947,this.var_218,name);
