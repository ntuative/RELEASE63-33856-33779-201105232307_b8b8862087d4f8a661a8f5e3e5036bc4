package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1344:int = 14;
      
      private static const const_1343:int = 500;
      
      private static const const_1416:Number = 100;
      
      private static const const_1417:Number = 100;
      ...
      protected var var_2162:String = "stickieui_container";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_703,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_703,this.onObjectUpdate);
      }
      ...
      protected function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1354 = param1.objectType;
         this._text = param1.text;
         this.var_334 = param1.colorHex;
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2162,"",HabboWindowType.const_77,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1416,const_1417,2,2),null,0) as IWindowContainer;
         ...
         if(_loc3_ != null)
         {
            ...
            _loc3_.addEventListener(WindowEvent.const_106,this.onTextWindowEvent);
         }
         _loc6_ = this._window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(this.var_1354 == "post_it_vd")
            {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + this.var_334);
            }
         ...
         this.setColorButtons(this._controller && this.var_1354 == "post_it");
      }
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_564,this.var_218,this._text,this.var_334);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_564,this.var_218,this._text,this.var_334);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_805,this.var_218);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1343;
         if(_loc2_.numLines < const_1344)
         {
            return;
         }
