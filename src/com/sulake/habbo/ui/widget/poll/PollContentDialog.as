package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1231;
         if(this.var_1231 < this.var_984.length)
         {
            _loc1_ = this.var_984[this.var_1231] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_442)
         {
            ...
            this.var_442 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_442.center();
            this.var_442.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_984[this.var_1231] as Dictionary;
