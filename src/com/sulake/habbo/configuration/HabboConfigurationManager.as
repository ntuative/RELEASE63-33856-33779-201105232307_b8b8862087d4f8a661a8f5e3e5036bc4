package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private static var var_1374:String = "%";
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_578 = this.getKey("url_prefix");
         if(this.var_578 != null && this.var_578.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_578 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function init() : void
      {
         ...
         if(!this.var_709)
         {
            ...
            _loc3_.addEventListener(AssetLoaderEvent.const_50,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. URL " + this.getKey("external.variables.txt") + "HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1705);
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc4_ && _loc4_ != "")
         {
            ...
            _loc6_.addEventListener(AssetLoaderEvent.const_50,this.onConfigurationOverrideError);
         }
         else if(!this.var_709)
         {
            this.var_709 = true;
            if(locked)
            {
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_578 = this.getKey("url.prefix");
         if(this.var_578.length > 0)
         {
            externalAccessDomain = this.var_578.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_886[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_886[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_578);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         ...
         if(this.var_1640.indexOf(param1) < 0 || param3)
         {
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1374);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1374,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
      ...
      {
         var _loc3_:String = this.var_886[param1] as String;
         if(_loc3_ == null)
         {
            return param2;
         }
