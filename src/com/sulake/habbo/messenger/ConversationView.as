package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1376:int = 10;
      
      private static const const_997:int = 100;
      
      private static const const_1375:int = 20;
       
      
      private var var_141:HabboMessenger;
      
      private var var_2232:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_141 = param1;
         this.var_1681 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_58 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2232 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_997 + const_1375)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1376;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1681.enable();
         }
         else
         {
            this.var_1681.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_58.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_492.messages.length - const_997);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_895 || param3.type == Message.const_971 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_141.send(new FollowFriendMessageComposer(this.var_492.id));
         this.var_141.send(new ConversionPointMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_892)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1128)
         {
            return 4288269465;
         }
         return 4291611852;
