package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1010:ConversationsTabView;
      
      private var var_921:ITextFieldWindow;
      
      private var var_17:IFrameWindow;
      
      private var var_1515:ConversationView;
      ...
      public function refresh() : void
      {
         ...
         this.var_1010.refresh();
         this.var_1515.refresh();
         if(this.var_141.conversations.openConversations.length < 1)
         {
            this.var_17.visible = false;
         }
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1515.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_1010 = new ConversationsTabView(this.var_141,this.var_17);
         this.var_1010.refresh();
         this.var_921 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_921.addEventListener(WindowKeyboardEvent.const_207,this.onMessageInput);
         this.var_1515 = new ConversationView(this.var_141,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_746,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1177,true);
         this.var_17.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_921.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_921.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_921.text;
         ...
         this.var_921.text = "";
         this.var_141.conversations.addMessageAndUpdateView(new Message(Message.const_895,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_1010 == null ? 7 : int(this.var_1010.getTabCount());
      }
   }
}
