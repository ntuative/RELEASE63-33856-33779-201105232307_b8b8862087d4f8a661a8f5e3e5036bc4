package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1321:int = 1;
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_846,0,this.var_473.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         return new Message(Message.const_892,0,this.getOnlineText(param1),Util.getFormattedNow());
      }
