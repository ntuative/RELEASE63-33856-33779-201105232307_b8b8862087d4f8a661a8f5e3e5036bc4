package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_996:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1373:String = "sendAccessTokenToServer";
      
      private static const const_1374:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1373,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1374,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_996);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_996);
         }
      }
