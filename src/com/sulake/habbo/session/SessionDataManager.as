package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1818:GroupDetailsView;
      ...
      private var var_615:ProductDataParser;
      ...
      private var var_1815:UserTagManager;
      
      private var var_1199:BadgeImageManager;
      
      private var var_1201:HabboGroupInfoManager;
      
      private var var_961:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2963 = [];
         this.var_1815 = new UserTagManager(events);
         this.var_1201 = new HabboGroupInfoManager(this,events);
         this.var_961 = new IgnoredUsersManager(this);
         this.var_1200 = new FaceBookSession();
         this.var_1163 = new Dictionary();
         this.var_1197 = [];
         this.var_962 = [];
         queueInterface(new IIDHabboWindowManager(),this.onWindowManagerReady);
         queueInterface(new IIDHabboCommunicationManager(),this.method_5);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_300)
         {
            this.var_300.removeEventListener(FurnitureDataParser.const_128,this.onFurnitureReady);
            this.var_300.dispose();
            this.var_300 = null;
         }
         if(this.var_615)
         {
            this.var_615.removeEventListener(ProductDataParser.const_128,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1199 = new BadgeImageManager(context.root.assets,events,this.var_188,this._localization);
      }
      ...
      private function method_5(param1:IID, param2:IUnknown) : void
      {
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_300)
         {
            ...
            this.var_300 = new FurnitureDataParser(this.var_511,this._wallItems,this.var_512,this._localization);
            this.var_300.addEventListener(FurnitureDataParser.const_128,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2494 = _loc2_.clubLevel;
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2638 = _loc3_.respectTotal;
         this.var_1198 = _loc3_.respectLeft;
         this._petRespectLeft = _loc3_.petRespectLeft;
         this.var_696 = _loc3_.figure;
         this.var_1080 = _loc3_.sex;
         this.var_1651 = _loc3_.realName;
         this.var_2495 = _loc3_.identityId;
         this.var_961.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_696 = _loc2_.figure;
            this.var_1080 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_696,this.var_1080));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2493 = _loc2_.isOpen;
         this.var_2492 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1817 >= SecurityLevelEnum.const_1202;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1815.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1199.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1199.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1818 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1201.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1818.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1199.getBadgeImage(param1,BadgeImageManager.const_1267);
      }
      ...
      {
         return this.var_961.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_961.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_961.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1198 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1198 = this.var_1198 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_511.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_512.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1197.indexOf(param1) == -1)
         {
            this.var_1197.push(param1);
         }
         if(!this.var_188)
         {
            return false;
         ...
         if(this.var_615 == null)
         {
            ...
            this.var_615 = new ProductDataParser(_loc2_,this.var_1163);
            this.var_615.addEventListener(ProductDataParser.const_128,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_511.getValues();
