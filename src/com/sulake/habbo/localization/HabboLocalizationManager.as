package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_1932:Dictionary;
      
      private var var_2678:Array;
      
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1932 = new Dictionary();
         this.var_2678 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1933 = (param2 & 0) > 0;
         if(!this.var_1933)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1933)
            {
               if("false" == this.var_188.getKey("use.default.localizations","false"))
               {
                  _loc5_ = this.var_188.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_186,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_186,this.onLocalizationLoaded);
         if(this.var_188.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_188.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_186,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_186,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_1932[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1932[param1];
      }
      ...
      {
         return this.var_2678[Math.max(0,param1 - 1)];
      }
   }
}
