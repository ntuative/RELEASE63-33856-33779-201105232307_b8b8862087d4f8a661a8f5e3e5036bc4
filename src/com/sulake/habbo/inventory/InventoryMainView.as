package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private const const_1943:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_822);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_390 != null && this.var_390 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_390 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_822);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_68:
               this._controller.furniModel.resetUnseenItems();
               break;
            case InventoryCategory.const_132:
               this._controller.petsModel.resetUnseenItems();
               break;
            case InventoryCategory.const_262:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_390);
         }
         ...
         _loc2_.container.removeChild(this.var_1999);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_390 == InventoryCategory.const_132)
            {
               this.toggleCategoryView(InventoryCategory.const_132);
            }
            else if(this.var_390 == InventoryCategory.const_68)
            {
               this.toggleCategoryView(InventoryCategory.const_68);
            }
            else if(this._controller != null)
            {
               this._controller.toggleInventoryPage(InventoryCategory.const_68);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2000)
         {
            this.var_2000 = this.createCounter("badges");
         }
         var _loc1_:int = this._controller.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2000,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_1053;
            _loc3_.y = const_1053;
         }
         return _loc3_;
      }
