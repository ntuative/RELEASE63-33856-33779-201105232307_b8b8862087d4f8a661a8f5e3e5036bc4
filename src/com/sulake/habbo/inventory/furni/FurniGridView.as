package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_204 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_204.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_204.autoArrangeItems = false;
            this.var_204.lock();
         }
         else
         {
            this.var_204.autoArrangeItems = true;
            this.var_204.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_69.toggleItemSelection(this._category,this.var_204.getGridItemIndex(param1.window));
            this.var_524 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_524 != null && this.var_524 == param2 && !this.var_69.isTradingOpen)
         {
