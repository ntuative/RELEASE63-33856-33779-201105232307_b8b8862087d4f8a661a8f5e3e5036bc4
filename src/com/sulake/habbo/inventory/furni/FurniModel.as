package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1557:int = 100;
      
      private static const const_1556:int = 1000;
      ...
      private var var_2041:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_471 = [];
         this.var_472 = [];
         this.var_684 = new Timer(const_1557,1);
         this.var_684.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2849 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_684.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_684.stop();
               this.var_684 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_2041 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2041;
            }
            else
            {
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_68);
         ...
         if(this.getSelectedItemIndex(const_42) == -1)
         {
            this.toggleItemSelection(const_42,0);
         }
         this.initListImages();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_304)
         {
         ...
         if(this.var_840 == null)
         {
            this.var_840 = this._windowManager.buildFromXML(this.var_2849) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_840.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_840.clone() as IWindowContainer;
      ...
      {
         if(param1 == InventoryCategory.const_68 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_267:
                  this._controller.toggleInventoryPage(InventoryCategory.const_132);
            }
         }
      }
      ...
      {
         this.var_2848 = getTimer();
         this.switchCategory(const_267);
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_380);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_685.add(const_39,new Array());
         this.var_685.add(const_42,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc6_ = const_42;
            _loc5_ = this.var_472.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_267)
            {
      ...
      {
         return getTimer() < this.var_2848 + const_1556;
      }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = this.getCategoryContent(const_42);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_329;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_304 || _loc3_.category == FurniCategory.const_303 || _loc3_.category == FurniCategory.const_312)
         {
            if(param1)
            {
               return false;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_329:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_685.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_985)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function updateView() : void
      {
         if(this._view != null)
         {
            ...
            this.updateGroupItems(const_42);
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_472.indexOf(_loc2_) == -1)
            {
               this.var_472.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            ...
            case UnseenItemCategoryEnum.const_406:
               return this.var_472.length;
            default:
               return this.var_471.length + this.var_472.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_42:
               if(this.var_472 && this.var_472.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_406));
                  this.var_472 = [];
