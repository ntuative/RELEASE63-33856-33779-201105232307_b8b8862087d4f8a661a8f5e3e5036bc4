package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1948:int = 0;
      ...
      private static const const_1021:int = 42;
      
      private static const const_1020:int = 120;
      
      private static const const_1019:int = 4;
      ...
      private var var_845:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_360.add(FurniModelCategory.const_39,new FurniGridView(this.var_69,FurniModelCategory.const_39,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_360.add(FurniModelCategory.const_42,new FurniGridView(this.var_69,FurniModelCategory.const_42,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1019;
            _loc3_.y = _loc4_.y + const_1019;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_360.getValue(this.var_436);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_69.getCategoryContent(this.var_436);
         ...
         if(this.var_2209 == _loc2_)
         {
            return;
         }
         this.var_2209 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_39,FurniModelCategory.const_42];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_360.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_360.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_360.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_360.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_69.getUnseenItemCount(UnseenItemCategoryEnum.const_390) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_69.getUnseenItemCount(UnseenItemCategoryEnum.const_406) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_69.getGroupItemInIndex(_loc3_,this.var_436);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_201);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_206);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_205);
            ...
            else if(_loc5_.category == FurniCategory.const_304)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_845 && this.var_845.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1299)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1020)
         {
            _loc3_ = const_1020;
         }
         else if(_loc3_ < const_1021)
         {
            _loc3_ = const_1021;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_49)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.switchCategory(FurniModelCategory.const_42);
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_267);
            }
         }
      }
