package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1095:uint = 4284532064;
      
      private static const const_1094:uint = 2577770;
      
      public static const const_1134:int = 0;
      ...
      private var var_692:ItemPopupCtrl;
      ...
      private var var_1068:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_692 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2084 = this.createMinimizedWindow();
         }
         if(!this.var_2886)
         {
            return this.var_71;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_71)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1095) : uint(const_1094);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1095) : uint(const_1094);
            }
         ...
         if(this.var_71)
         {
            ...
            switch(this.var_20.state)
            {
               ...
               case TradingModel.const_353:
                  ...
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_612:
                  _loc1_.disable();
                  this.showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_293:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
      ...
      public function removeSelection() : void
      {
         if(this.var_1068)
         {
            this.var_1068.isSelected = false;
            this.var_1068 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1842)
            {
            ...
            this.var_692.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_502);
            this.var_692.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_692.hideDelayed();
         }
      }
         ...
         if(this.var_195.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_692.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_502);
               }
            }
            else
            {
