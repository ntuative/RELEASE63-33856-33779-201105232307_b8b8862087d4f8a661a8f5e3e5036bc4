package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1739:uint = 9;
      
      public static const const_196:uint = 0;
      
      public static const const_203:uint = 1;
      
      public static const const_373:uint = 2;
      
      public static const const_353:uint = 3;
      
      public static const const_612:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_55.updateItemList(this.var_711);
         this.var_55.updateItemList(this.var_1376);
      ...
      public function close() : void
      {
         if(this.var_768)
         {
            if(this._state != const_196 && this._state != const_293)
            {
      ...
      {
         this.var_55.setMinimized(param1 != InventoryCategory.const_68);
         this.var_13.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_710 + " OTHER: " + this.var_1099);
         ...
         {
            case const_196:
               if(param1 == const_203 || param1 == const_293)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_244 == null || this.var_244.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_244.length)
         {
            _loc2_ = this.var_244.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_55.alertPopup(TradingView.const_1279);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_711)
            {
               this.var_710 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1099 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_55.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_711)
            {
               this.var_55.alertPopup(TradingView.const_1330);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_244.length < const_1739)
         {
         ...
         else
         {
            ...
            if(this.var_244.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
