package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1372:int = 13421772;
      
      private static const const_1371:int = 10275685;
      ...
      private var var_1386:IWindow;
      
      private var var_2219:IWindow;
      ...
      protected var var_2943:BitmapData;
      
      private var var_1595:Boolean;
      
      private const const_1979:Number = 1;
      
      private const const_1978:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1386 = this._window.findChildByTag("BG_COLOR");
         this.var_2219 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_2943 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2170 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1455));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2169);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_985)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1978;
               _loc1_.blend = this.const_1978;
            }
            else
            {
               this._window.blend = this.const_1979;
               _loc1_.blend = this.const_1979;
            }
         }
         this.var_1386.color = !!this.var_1595 ? uint(const_1371) : uint(const_1372);
         this.var_2219.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2171 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2943;
               _loc5_.visible = true;
            }
            else
            {
