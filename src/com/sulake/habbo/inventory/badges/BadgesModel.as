package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2217:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_376 = param5;
         this.var_376.events.addEventListener(BadgeImageReadyEvent.const_112,this.onBadgeImageReady);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1190.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_611.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_376.getBadgeImage(param1);
            if(_loc10_)
            {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_226[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_496);
      ...
      {
         return this.getItemInIndex(param1,const_496);
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1175));
            this.var_611 = [];
