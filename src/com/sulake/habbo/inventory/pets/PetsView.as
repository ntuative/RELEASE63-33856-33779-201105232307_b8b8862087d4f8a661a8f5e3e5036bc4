package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1948:int = 0;
      
      private const const_1022:int = 1;
      
      private const const_1023:int = 2;
      ...
      private var var_204:IItemGridWindow;
      ...
      private var var_217:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_204 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_217);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_509.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_204.removeGridItem(_loc2_.window);
         if(this.var_217 == _loc2_)
         {
            this.var_217 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_509 == null || this.var_509.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_509.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_509.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_204.addGridItem(_loc2_.window);
            this.var_509.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_217.pet;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowEvent.const_49)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.var_69.switchToFurnitureCategory(FurniModelCategory.const_42);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_217 != null)
         {
            this.var_217.setSelected(false);
         }
         this.var_217 = param1;
         if(this.var_217 != null)
         {
            this.var_217.setSelected(true);
         }
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1022;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1023;
         }
         else
         {
            _loc2_ = this.const_1024;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1022:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1023:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1024:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_69.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_390) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_69.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_406) > 0;
