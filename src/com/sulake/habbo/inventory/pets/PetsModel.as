package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_132 && this._controller.isVisible)
         {
      ...
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this._controller.toggleInventoryPage(InventoryCategory.const_68,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_2018 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_32,RoomObjectTypeEnum.const_213,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_2018 && param1.type == RoomEngineObjectEvent.const_145)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_553.indexOf(_loc2_) == -1)
            {
               this.var_553.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_553 && this.var_553.length > 0)
         {
      ...
      {
         return this.var_553.length;
      }
      
      public function isUnseen(param1:int) : Boolean
      {
         return this.var_553.indexOf(param1) > -1;
      }
   }
}
