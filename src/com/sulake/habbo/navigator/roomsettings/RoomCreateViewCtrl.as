package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_591 = new Timer(100);
         this.var_591.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_44 = new Array();
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,104,"a"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,94,"b"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,36,"c"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,84,"d"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,80,"e"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,80,"f"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,416,"i"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,320,"j"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,448,"k"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,352,"l"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,384,"m"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_58,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_591)
         {
            this.var_591.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_591.reset();
            this.var_591 = null;
         }
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1698 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1698 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_58 = IItemListWindow(this.var_178.findChildByName("item_list"));
         ...
         this.var_1136 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_178.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1136.goBackToInitialState();
         this.var_1136.input.textBackgroundColor = 4294967295;
         this.var_1135 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_77,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1136.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1136.getText();
