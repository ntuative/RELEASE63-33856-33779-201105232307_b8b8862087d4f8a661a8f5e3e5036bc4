package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      {
         this.var_366 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_366));
      ...
      {
         if(param1 != this.var_366 || this.var_1202 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1202 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1911)
         {
            this.var_757.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1668)
         {
            this.var_757.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1782)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1800)
         {
         ...
         {
            this.var_967.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_757.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_469,this.onDoorModePasswordUnselect);
         ...
         this.var_757 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         ...
         this.var_967 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1209 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1210 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1206 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1203 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_758 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1819 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         ...
         this.var_2496 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1208 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1204 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1820 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1462 = IWindowContainer(this._window.findChildByName("footer_container"));
         ...
         this.var_1464 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1464.mouseThreshold = 0;
         this.var_1464.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1207.visible = false;
         if(!this.var_1463)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1820.visible = this.var_1463;
         this.populateForm();
         if(this.var_756)
         {
         ...
         else
         {
            ...
            this.var_1462.visible = true;
            this.var_2496.visible = this.var_1463;
            this.var_1208.height = Util.getLowestPoint(this.var_1208) + 4;
         }
         this.var_1464.text = !!this.var_756 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1208.name,this.var_1204.name,this.var_1462.name,this.var_1820.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_757.setText(_loc1_.name);
         this.var_1205.setText(_loc1_.description);
         this.var_967.setText("");
         ...
         {
            case RoomSettingsData.const_216:
         ...
         if(this.var_1206)
         {
            ...
            {
               this.var_1206.select();
            }
            else
            {
               this.var_1206.unselect();
            }
         }
         if(this.var_1203)
         {
         ...
         {
            this.disableWindow(this.var_758);
            this.disableWindow(this.var_965);
            this.disableWindow(this.var_966);
            this.disableWindow(this.var_1819);
         }
         else
         {
            this.enableWindow(this.var_758);
            this.enableWindow(this.var_965);
            this.enableWindow(this.var_966);
            this.enableWindow(this.var_1819);
         }
         if(this.var_758)
         {
            if(_loc1_.hideWalls)
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_757.getText();
         ...
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_216;
               break;
         ...
         _loc2_.allowPets = this.var_1210.isSelected;
         _loc2_.allowFoodConsume = this.var_1206.isSelected;
         _loc2_.allowWalkThrough = this.var_1203.isSelected;
         _loc2_.hideWalls = this.var_758.isSelected;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_366);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_78.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_366]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_77,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_366));
      }
