package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_580:RoomInfoViewCtrl;
      
      private var var_1103:RoomCreateViewCtrl;
      ...
      private var var_967:GuestRoomPasswordInput;
      
      private var var_327:GuestRoomDoorbell;
      
      private var var_1104:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_580 = new RoomInfoViewCtrl(this);
         this.var_1103 = new RoomCreateViewCtrl(this);
         this.var_2207 = new RoomThumbnailRenderer(this);
         this.var_967 = new GuestRoomPasswordInput(this);
         this.var_327 = new GuestRoomDoorbell(this);
         this.var_437 = new Tabs(this);
         this.var_1104 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_317,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_290.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_290.startSearch(Tabs.const_223,Tabs.const_381,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_290.startSearch(Tabs.const_291,Tabs.const_283);
         this.var_437.getTab(Tabs.const_291).tabPageDecorator.tabSelected();
      }
