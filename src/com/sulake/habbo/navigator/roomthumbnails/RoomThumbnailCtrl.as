package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2066:IButtonWindow;
      
      private var var_2067:IButtonWindow;
      
      private var var_2068:IButtonWindow;
      
      private var var_2870:IWindowContainer;
      
      private var var_2871:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2066 = IButtonWindow(this.find("bg_tab"));
         this.var_2067 = IButtonWindow(this.find("top_tab"));
         this.var_2068 = IButtonWindow(this.find("obj_tab"));
         this.var_2870 = IWindowContainer(this.find("tile_grid"));
         this.var_2871 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2066,this.onBgTabButton);
         Util.setProcDirectly(this.var_2067,this.onTopTabButton);
         Util.setProcDirectly(this.var_2068,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_69.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_2066,this.var_69.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_2067,this.var_69.mode != ThumbnailEditorModel.const_61);
         this.setEnabled(this.var_2068,this.var_69.mode != ThumbnailEditorModel.const_36);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2871;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_69.mode == ThumbnailEditorModel.const_37);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2870;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_77,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_614,HabboWindowStyle.const_47,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_317,HabboWindowStyle.const_47,HabboWindowParam.const_65,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
