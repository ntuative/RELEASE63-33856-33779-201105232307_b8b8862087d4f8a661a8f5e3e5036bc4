package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_439)
         {
            this.var_439.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_439.reset();
            this.var_439 = null;
         }
         if(this.var_363)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_57 == null)
         {
            this.var_57 = IWindowContainer(this._navigator.getXmlWindow(this.var_1089));
            this.var_57.visible = false;
            this.var_57.setParamFlag(HabboWindowParam.const_45,true);
         ...
         this.var_57.x = _loc2_.x + this.var_2437 + param1.width;
