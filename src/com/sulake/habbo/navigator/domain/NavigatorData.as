package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private static const const_1944:int = 10;
       
      
      private var _navigator:HabboNavigator;
      
      private var var_200:MsgWithRequestId;
      
      private var var_597:RoomEventData;
      ...
      {
         return this.var_200 != null && this.var_200 as PopularRoomTagsData != null;
      }
      
      public function get guestRoomSearchArrived() : Boolean
      {
         return this.var_200 != null && this.var_200 as GuestRoomSearchResultData != null;
      }
      
      public function get officialRoomsArrived() : Boolean
      {
         return this.var_200 != null && this.var_200 as OfficialRoomsData != null;
      }
      ...
      {
         return this.var_200 as GuestRoomSearchResultData;
      }
      
      public function get popularTags() : PopularRoomTagsData
      {
         return this.var_200 as PopularRoomTagsData;
      }
      
      public function get officialRooms() : OfficialRoomsData
      {
         return this.var_200 as OfficialRoomsData;
      }
      ...
      public function onFavourites(param1:FavouritesMessageParser) : void
      {
         ...
         this.var_1423 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      {
         return this.var_1423 >= this.var_2316;
      }
