package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_514:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_514 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.addEventListener(WindowMouseEvent.const_195,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1780,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_216,null,0);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_514.visible && this.var_2518)
         {
            return;
         }
         ...
         this.var_514.room = _loc4_;
         this.var_514.showPopup(_loc2_);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1472.tags[0];
            this.var_1472.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2517 - _loc2_.stageX);
         this.var_2517 = _loc2_.stageX;
         this.var_2518 = _loc3_ > 2;
      }
   }
}
