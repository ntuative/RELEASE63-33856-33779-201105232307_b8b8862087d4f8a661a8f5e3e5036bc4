package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1067:IDesktopWindow;
      ...
      private var var_843:IAssetLibrary;
      
      private var var_1320:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_843 = param2;
         this._events = param3;
         this.var_1067 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_843.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_29,this.hotelViewLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_50,this.hotelViewLoadedHandler);
         }
         else
         {
            this.var_1318 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_29,this.hotelViewLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_50,this.hotelViewLoadedCallbackHandler);
         }
         ++this.var_1320;
      }
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_843.getAssetByName(_loc2_.assetName);
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_50,this.hotelViewLoadedHandler);
      }
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_29)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_498));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this.var_1318 != null)
            {
               this.var_1318(_loc4_);
               this.var_1318 = null;
            }
         }
         _loc2_.removeEventListener(AssetLoaderEvent.const_29,this.hotelViewLoadedCallbackHandler);
         _loc2_.removeEventListener(AssetLoaderEvent.const_50,this.hotelViewLoadedCallbackHandler);
      }
      
      public function loadBannerImage(param1:String, param2:Function) : void
      {
         var _loc3_:AssetLoaderStruct = this.var_843.loadAssetFromFile("hotel_view_banner_" + this.var_1320,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_29,this.bannerLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_50,this.bannerLoadedHandler);
         }
         else
         {
            if(this._events != null)
            ...
            _loc3_.addEventListener(AssetLoaderEvent.const_50,this.bannerLoadedCallbackHandler);
         }
         ++this.var_1320;
      }
      ...
      private function bannerLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_50,this.bannerLoadedHandler);
      }
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_50,this.bannerLoadedCallbackHandler);
      }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1067.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1067.removeChild(this._window);
         }
      }
   }
}
