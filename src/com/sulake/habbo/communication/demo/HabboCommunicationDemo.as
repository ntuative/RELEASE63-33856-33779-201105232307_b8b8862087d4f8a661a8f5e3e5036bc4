package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_54:IHabboCommunicationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_16:IRoomSessionManager;
      
      private var var_489:IKeyExchange;
      
      private var var_885:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2180:PseudoRandom;
      ...
      private var var_220:HabboHotelView;
      
      private var var_1371:String = "";
      
      private const const_1937:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_577 = param1;
            this.var_54.initConnection(HabboConnectionType.const_252);
         }
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            this.var_54 = param2 as IHabboCommunicationManager;
            _loc3_ = this.var_54.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            this.var_54.addHabboConnectionMessageEvent(new HelloMessageEvent(this.onHelloEvent));
            this.var_54.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(this.onInitCrypto));
            this.var_54.addHabboConnectionMessageEvent(new SecretKeyEvent(this.onSecretKeyEvent));
            this.var_54.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(this.onSessionParamsEvent));
            this.var_54.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            this.var_54.addHabboConnectionMessageEvent(new PingMessageEvent(this.onPing));
            this.var_54.addHabboConnectionMessageEvent(new ErrorReportEvent(this.onErrorReport));
            this.var_54.addHabboConnectionMessageEvent(new UserObjectEvent(this.onUserObject));
            this.var_54.addHabboConnectionMessageEvent(new GenericErrorEvent(this.onGenericError));
            this.var_54.addHabboConnectionMessageEvent(new DisconnectReasonEvent(this.onDisconnectReason));
            this.var_54.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(this.onRoomEntryInfoEvent));
            this.var_54.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(this.onUniqueMachineId));
            this.var_54.addHabboConnectionMessageEvent(new IdentityAccountsEvent(this.onIdentityAccounts));
            this.checkRequirements();
         }
      }
      ...
      {
         if(this.var_54 && this.var_133 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_220 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         ...
         {
            this.var_220.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_133.getKey("use.sso.ticket") == "1";
         this.var_577 = this.var_133.getKey("sso.ticket",null);
         this.var_1637 = this.var_133.getKey("flash.client.url","");
         this.var_2178 = this.var_133.getKey("external.variables.txt","");
         if(this.var_220 == null)
         {
            this.var_220 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_54.mode = HabboConnectionType.const_95;
            if(this.var_577)
            {
               this.var_54.initConnection(HabboConnectionType.const_252);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_615,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1654);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_54.mode = HabboConnectionType.const_1189;
            }
         }
         this.var_54.initConnection(HabboConnectionType.const_252);
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = this.var_54.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_821);
            _loc3_ = new InitCryptoMessageComposer(this.var_54.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2180 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_54.mode)
         {
            case HabboConnectionType.const_95:
               ...
               this.var_220.loadBannerImage(_loc7_ + "?token=" + this.var_1371,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1189:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1912:
               this.var_885 = this.generateRandomHexString(30);
               this.var_489 = new DiffieHellman(new BigInteger(this.var_133.getKey("connection.development.prime"),16),new BigInteger(this.var_133.getKey("connection.development.generator"),16));
               this.var_489.init(this.var_885);
               _loc8_ = this.var_489.getPublicKey(10);
               _loc2_.send(new GenerateSecretKeyMessageComposer(_loc8_.toUpperCase()));
               break;
            default:
               Logger.log("[HabboCommunicationDemo] Unknown Connection Mode: " + this.var_54.mode);
         }
      }
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_489.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_489.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2180);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1372 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_286);
         connection.send(new VersionCheckMessageComposer(401,this.var_1637,this.var_2178));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1937,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_577 != null)
         {
            ...
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_191);
         }
      ...
      {
         var _loc4_:IConnection = this.var_54.getHabboMainConnection(null);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2179)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1371);
         ...
         var _loc9_:IConnection = this.var_54.getHabboMainConnection(null);
         ...
         this.var_489 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_489.init(_loc14_);
            _loc15_ = this.var_489.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_885 = _loc14_;
            }
