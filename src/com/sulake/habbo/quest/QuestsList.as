package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1598:int = 10;
      
      private static const const_1597:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_736 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_736.toggle();
         this.var_2081 = false;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_58.spacing = const_1600;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1598;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1599;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1597;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2081 && !this.var_2082)
            {
               this.var_2081 = false;
