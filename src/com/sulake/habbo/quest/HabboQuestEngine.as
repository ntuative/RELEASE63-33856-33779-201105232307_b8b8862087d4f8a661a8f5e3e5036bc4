package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private var var_1191:QuestController;
      
      private var var_953:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1191 = new QuestController(this);
         this.var_953 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1420);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_376.events.removeEventListener(BadgeImageReadyEvent.const_112,this.var_953.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_376.events.addEventListener(BadgeImageReadyEvent.const_112,this.var_953.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1191.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_953.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1191.questTracker.isVisible();
      }
      ...
      {
         return this.var_188.getKey("questing.enabled","false") == "true";
      }
      ...
      {
         this.var_1191.update(param1);
         this.var_953.update(param1);
      }
   }
}
