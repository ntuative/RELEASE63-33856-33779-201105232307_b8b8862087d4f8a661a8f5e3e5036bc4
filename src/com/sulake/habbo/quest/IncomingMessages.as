package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1844:IAlertDialog;
      ...
      public function onLevelUp(param1:IMessageEvent) : void
      {
         ...
         this._questEngine.send(new ConversionPointMessageComposer("Achievements","" + _loc3_.type,"Leveled","" + _loc3_.level));
      }
