package com.sulake.habbo.quest
{
   ...
   public class AchievementCategories
   {
      ...
      public function AchievementCategories(param1:Array)
      {
         ...
         {
            _loc3_ = this.var_169[_loc2_.category];
            if(_loc3_ == null)
            {
               _loc3_ = new AchievementCategory(_loc2_.category);
               this.var_169[_loc2_.category] = _loc3_;
               this.var_1177.push(_loc3_);
            }
            _loc3_.add(_loc2_);
         }
      }
      ...
      {
         var _loc2_:AchievementCategory = this.var_169[param1.category];
