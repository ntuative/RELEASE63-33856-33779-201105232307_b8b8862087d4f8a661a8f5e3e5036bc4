package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1875:int = 10000;
      ...
      private var var_1330:IEncryption;
      
      private var var_856:IProtocol;
      
      private var _id:String;
      
      private var var_1331:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1331 = new MessageClassManager();
         this.var_80 = new Socket();
         this.var_215 = new Timer(const_1875,1);
         this.var_215.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_215.stop();
            this.var_215.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_215 = null;
         this.var_564 = null;
         this.var_565 = null;
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1331.method_8(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_856.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_565)
         {
         ...
         {
            _loc3_ = this.var_1330.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1331.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_856.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_856.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1330 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_856.getMessages(this.var_564,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1331.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_564.writeByte(this.var_80.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_215.stop();
         this.var_2083 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_857));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2083 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_857));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_857));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_857));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_857));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_857));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_215.delay + " ms). Possible Firewall.";
