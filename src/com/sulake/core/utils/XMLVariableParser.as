package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_284:String = "uint";
      
      public static const const_120:String = "Number";
      
      public static const const_1791:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1792:String = "bool";
      
      public static const const_52:String = "String";
      
      public static const const_236:String = "Point";
      
      public static const const_254:String = "Rectangle";
      
      public static const const_165:String = "Array";
      
      public static const const_243:String = "Map";
      
      private static const const_660:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_661:String = "value";
      
      private static const const_676:String = "true";
      
      private static const const_1964:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_660);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_660));
         }
         else
         {
            _loc4_ = param1.child(const_660)[0];
         }
         ...
         _loc7_ = param1.attribute(const_661);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_661));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_661)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_243 || _loc5_ == const_165)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1791:
               return Number(param1);
            case const_38:
               return param1 == const_676 || int(param1) > 0;
            case const_1792:
               return param1 == const_676 || int(param1) > 0;
            case const_138:
               return uint(param1);
            case const_165:
               return param1.split(const_1492);
            default:
