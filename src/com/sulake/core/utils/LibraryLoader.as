package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1929:uint = 1;
      
      protected static const const_1932:uint = 2;
      
      protected static const const_1931:uint = 4;
      
      protected static const const_1930:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1628:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1292:Boolean = false;
      
      public static const const_1853:int = 2;
      
      private static var var_1054:Array = new Array();
      
      private static var var_831:Array = new Array();
      ...
      protected var var_243:URLRequest;
      
      protected var _manifest:XML;
      
      protected var var_655:Class;
      
      protected var var_486:uint = 0;
      ...
      protected var var_1094:Boolean = false;
      
      protected var var_2937:String = "";
      
      protected var var_2938:String = "";
      
      protected var var_2167:int;
      
      protected var var_1358:int;
      
      protected var var_1357:int;
      
      protected var var_3002:uint = 0;
      
      protected var var_2939:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         if(const_1292)
         {
            if(var_1054.indexOf(param1) == -1)
            {
               var_1054.push(param1);
            }
            throttle();
         }
         else
         {
            param1.var_43.load(param1.var_243,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1292)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_831[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_831.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_831.length < const_1853 && false)
            {
               _loc1_ = var_1054.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_831.push(_loc1_);
                  _loc1_.var_43.load(_loc1_.var_243,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_243 ? this.var_243.url : null;
      }
      ...
      {
         return !!this.var_1093 ? uint(this.var_1358 - this.var_2167) : uint(getTimer() - this.var_2167);
      }
      ...
      {
         this.var_243 = param1;
         this._name = parseNameFromUrl(this.var_243.url);
         this.var_1093 = false;
      ...
      {
         if(this.var_1094 && !_disposed)
         {
            this.var_1094 = false;
            if(!this.var_1093 && this.var_243)
            {
               this.var_1358 = -1;
               this.var_2167 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1093 && !_disposed && this.var_1357 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_243,const_1628 - this.var_1357);
            if(this.var_2939)
            {
               this.var_243.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_243.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2939 = false;
            }
            --this.var_1357;
            this.var_486 = 0;
            this.var_43.load(this.var_243,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_486 = LibraryLoader.name_4;
         ...
         if(this.var_486 == LibraryLoader.const_1930)
         {
         ...
         if(this.var_486 == LibraryLoader.name_4)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         if(this.var_655 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_243.url + "!");
            }
            return false;
         }
