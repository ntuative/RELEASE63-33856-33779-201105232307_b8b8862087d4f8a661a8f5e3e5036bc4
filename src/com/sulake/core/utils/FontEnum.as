package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_669:Map = new Map();
      
      private static const const_370:Map = new Map();
      
      private static var var_1286:Boolean = false;
      ...
      {
         return const_669.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1286)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_669.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1286 = true;
         }
