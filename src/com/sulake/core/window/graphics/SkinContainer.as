package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_995:uint = 8;
      
      private static const const_1355:String = "skin";
      
      private static const const_1354:String = "bitmap";
      
      private static const const_1357:String = "fill";
      
      private static const const_1358:String = "text";
      
      private static const const_1353:String = "label";
      
      private static const const_1356:String = "shape";
      ...
      private var var_1648:Dictionary;
      
      private var var_2196:Dictionary;
      
      private var var_2195:Dictionary;
      
      private var var_2197:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1648 = new Dictionary();
         this.var_2196 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1648,this.var_2196);
         this.var_2195 = new Dictionary();
         this.var_2197 = new Dictionary();
         StateCodeTable.fillTables(this.var_2195,this.var_2197);
         this.var_410 = new Dictionary();
         this.var_410[const_1355] = BitmapSkinRenderer;
         this.var_410[const_1354] = BitmapDataRenderer;
         this.var_410[const_1357] = FillSkinRenderer;
         this.var_410[const_1358] = TextSkinRenderer;
         this.var_410[const_1353] = LabelRenderer;
         this.var_410[const_1356] = ShapeSkinRenderer;
         this.var_410[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_410[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_339 == null)
         {
            var_339 = new Array();
            var_339.push(WindowState.const_71);
            var_339.push(WindowState.const_89);
            var_339.push(WindowState.const_97);
            var_339.push(WindowState.const_56);
            var_339.push(WindowState.const_85);
            var_339.push(WindowState.const_88);
            var_339.push(WindowState.const_87);
            var_339.push(WindowState.const_102);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2919 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1648[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_889[param1] = new Array(const_995);
         }
         this.var_889[param1][param2] = param3;
         if(this.var_890[param1] == null)
         {
            this.var_890[param1] = new Array(const_995);
         }
         this.var_890[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_889[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_183)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_890[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_183)
