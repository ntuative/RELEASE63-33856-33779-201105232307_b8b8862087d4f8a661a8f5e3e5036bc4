package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_876:Dictionary;
      
      protected var var_875:Dictionary;
      
      private var var_255:Matrix;
      ...
      public function BitmapSkinRenderer(param1:String)
      {
         ...
         this.var_875 = new Dictionary(false);
         this.var_255 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc2_ = this.var_876[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_876[_loc1_];
            }
            this.var_876 = null;
            for(_loc1_ in this.var_875)
            {
               _loc2_ = this.var_875[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_875[_loc1_];
            }
            this.var_875 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_481[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_753.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_753.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_753.blueMultiplier = (param1.color & 255) / 255;
               this.var_753.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_753);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_332 == SkinLayoutEntity.const_332)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_500)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_307)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_491)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_331 == SkinLayoutEntity.const_332)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_500)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_307)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_491)
                  {
                  ...
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_307 || _loc10_.var_332 == SkinLayoutEntity.const_307)
                  {
                  ...
                  {
                     this.var_255.a = REGION.width;
                     this.var_255.d = REGION.height;
                     this.var_255.tx = REGION.x;
                     this.var_255.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_255,ALPHA);
                  }
                  else
                  {
                     this.var_255.a = 0 / _loc18_.width;
                     this.var_255.d = 0 / _loc18_.height;
                     this.var_255.tx = 0;
                     this.var_255.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_255);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_255,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_332 == SkinLayoutEntity.const_332)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_331 == SkinLayoutEntity.const_332)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_876[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_875[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
