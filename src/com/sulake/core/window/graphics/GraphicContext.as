package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1784:uint = 0;
      
      public static const const_979:uint = 1;
      
      public static const const_1303:uint = 2;
      
      public static const const_871:uint = 4;
      
      public static const const_1702:uint = 8;
      
      public static const const_1751:uint = 16;
      
      public static const const_2109:uint = 64;
      
      public static const const_2172:uint = 128;
      
      public static const const_1153:uint = 256;
      
      protected static var var_576:uint = 0;
      
      protected static var var_340:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_979:
               ...
               break;
            case GraphicContext.const_1303:
               ...
               break;
            case GraphicContext.const_1702:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1751:
         ...
         if(this.var_879)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_340 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2166,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2166,16777215);
                  }
                  var_340 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_879)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_340 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
