package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_102:String = "HabboAvatarEditorCom_bottom_trousers_on";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_332 = SkinLayoutEntity.const_505;
                  break;
               case "move":
                  _loc5_.var_332 = SkinLayoutEntity.const_332;
                  break;
               case "strech":
                  _loc5_.var_332 = SkinLayoutEntity.const_500;
                  break;
               case "tiled":
                  _loc5_.var_332 = SkinLayoutEntity.const_307;
                  break;
               case "center":
                  _loc5_.var_332 = SkinLayoutEntity.const_491;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_331 = SkinLayoutEntity.const_505;
                  break;
               case "move":
                  _loc5_.var_331 = SkinLayoutEntity.const_332;
                  break;
               case "strech":
                  _loc5_.var_331 = SkinLayoutEntity.const_500;
                  break;
               case "tiled":
                  _loc5_.var_331 = SkinLayoutEntity.const_307;
                  break;
               case "center":
                  _loc5_.var_331 = SkinLayoutEntity.const_491;
            }
         }
