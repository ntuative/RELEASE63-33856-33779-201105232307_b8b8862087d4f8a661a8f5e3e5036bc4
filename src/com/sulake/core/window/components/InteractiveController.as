package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_533)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_195)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_533)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_942,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1923);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1265)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_843,param1.toolTipDelay,PropertyStruct.const_284,true));
         }
         else
         {
      ...
      {
         this.var_1349 = param1 == null ? "null" : param1;
      }
