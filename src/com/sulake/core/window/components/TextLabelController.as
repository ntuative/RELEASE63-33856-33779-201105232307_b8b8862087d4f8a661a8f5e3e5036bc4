package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_380:Object = null;
      ...
      {
         return this.var_380 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_447);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_380 != null)
            {
               _loc1_.textColor = uint(this.var_380);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_447 != param1.name)
         {
            this.var_447 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2646 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_380 != _loc2_.color : this.var_380 != null && this.var_380 != PropertyDefaults.const_905) ? new PropertyStruct(PropertyDefaults.const_395,this.var_380,PropertyStruct.const_138,true) : PropertyDefaults.const_1126);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_929)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,this.var_41.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_689);
            }
            if(this.var_41.top != PropertyDefaults.const_850)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_258,this.var_41.top,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_831);
            }
            if(this.var_41.right != PropertyDefaults.const_771)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_278,this.var_41.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_732);
            }
            if(this.var_41.bottom != PropertyDefaults.const_924)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,this.var_41.bottom,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_708);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_395:
                  this.var_380 = _loc2_.value as uint;
                  break;
               case PropertyDefaults.const_260:
                  if(this.var_41 || _loc2_.method_1)
                  {
