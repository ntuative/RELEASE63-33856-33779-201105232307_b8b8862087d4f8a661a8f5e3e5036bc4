package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_1955:String = "_POINTER_UP";
      
      private static const const_1953:String = "_POINTER_DOWN";
      
      private static const const_1956:String = "_POINTER_LEFT";
      
      private static const const_1954:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_857,this._direction,PropertyStruct.const_52,true));
         }
         else
         {
