package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1395:String = "_TITLE";
      
      private static const const_1396:String = "_HEADER";
      
      private static const const_1394:String = "_CONTENT";
      
      private static const const_1393:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1413:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1395) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1413 = findChildByTag(const_1396) as IHeaderWindow;
            if(!this.var_1413)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_178 = findChildByTag(const_1394) as IWindowContainer;
            if(!this.var_178)
            {
      ...
      {
         return findChildByTag(const_1393) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1338,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1093 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_337);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,_loc3_.left,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_258,_loc3_.top,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_278,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         return _loc1_;
      }
