package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_945:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_751:String;
      
      private var var_1174:String = null;
      
      private var var_1763:StyleSheet = null;
      ...
      {
         this.var_751 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1174 == param2)
         {
            return;
         }
         param1.var_1174 = param2;
         param1.var_1763 = null;
         if(param1.var_1174 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1174);
            param1.var_1763 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_960.indexOf(param1) > -1)
         {
            this.var_751 = param1;
         }
      }
      ...
      {
         return this.var_751 == LinkTarget.const_30 ? defaultLinkTarget : this.var_751;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1763;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1167)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_751 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_887,this.var_751,PropertyStruct.const_52,true,PropertyDefaults.const_960));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1639);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_887)
            {
               this.var_751 = _loc2_.value as String;
               break;
            }
