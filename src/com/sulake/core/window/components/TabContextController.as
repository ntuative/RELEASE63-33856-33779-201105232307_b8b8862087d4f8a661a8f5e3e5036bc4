package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1377:String = "_SELECTOR";
      
      private static const const_1378:String = "_CONTENT";
       
      
      protected var var_1088:ITabSelectorWindow;
      
      protected var var_2150:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1088 = findChildByTag(const_1377) as ITabSelectorWindow;
            if(this.var_1088 != null)
            {
               this.var_1088.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2150 = findChildByTag(const_1378) as IWindowContainer;
         }
      ...
      {
         return !!this.var_709 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1088.numSelectables;
      }
