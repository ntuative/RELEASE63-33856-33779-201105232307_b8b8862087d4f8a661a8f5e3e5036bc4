package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1183:IItemListWindow;
      
      private var var_440:IScrollbarWindow;
      
      private var var_1784:Boolean = true;
      ...
      override public function dispose() : void
      {
         if(this.var_440)
         {
            this.var_440.removeEventListener(WindowEvent.const_272,this.scrollBarEventProc);
            this.var_440.removeEventListener(WindowEvent.const_242,this.scrollBarEventProc);
            this.var_440 = null;
         }
         if(this.var_1183)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1183)
         {
            this.var_1183 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_440)
         {
            this.var_440 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_440)
            {
               this.var_440.addEventListener(WindowEvent.const_272,this.scrollBarEventProc);
               this.var_440.addEventListener(WindowEvent.const_242,this.scrollBarEventProc);
            }
         }
         return this.var_440;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_242)
         {
            this.hideScrollBar();
         }
      }
