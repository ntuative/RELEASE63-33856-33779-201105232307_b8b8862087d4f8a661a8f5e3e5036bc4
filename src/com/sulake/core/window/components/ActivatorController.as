package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_310)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1158)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_882;
         if(this.var_882 != param1)
         {
            if(this.var_882 != null)
            {
               if(!this.var_882.disposed)
               {
                  this.var_882.deactivate();
               }
            }
            this.var_882 = param1;
