package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_446:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_604:int = -1;
      
      private var var_943:Boolean = false;
      
      private var var_182:DropMenuController;
      ...
      {
         if(param1 > this.var_254.lenght - 1)
         {
      ...
      {
         if(this.var_182 != null && !this.var_182.disposed)
         {
            this.var_182.destroy();
            this.var_182 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_446) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_182 == null || this.var_182.disposed)
         {
            this.var_182 = context.create(name + "::submenu","",WindowType.const_490,var_82,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_182.setGlobalRectangle(_loc1_);
         }
         this.var_182.activate();
         return this.var_182;
      }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_254.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_943 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_182.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_943)
         {
            if(this.open())
            {
               if(this.var_254.length)
               {
                  this.populateMenuItemContainer(this.var_254,this.getSubMenu(),this.subMenuEventProc);
                  this.var_943 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_943 = false;
            this.getTitleLabel().text = this.var_604 < this.var_254.length && this.var_604 > -1 ? this.var_254[this.var_604] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_464,var_82,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_412,var_82,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_604 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_604).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_922)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1186:
            case WindowMouseEvent.const_54:
               ...
               break;
            case WindowTouchEvent.const_956:
      ...
      public function open() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1743,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1671,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1844,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_254[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_254.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_731,this.var_254,PropertyStruct.const_165,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_731)
            {
