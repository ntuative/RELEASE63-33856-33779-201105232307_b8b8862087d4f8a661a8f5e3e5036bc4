package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1341:Dictionary = createPropertySetterTable();
      ...
      protected var var_131:Boolean = false;
      
      protected var var_1090:Boolean = false;
      
      private var var_447:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_447,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_447 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_447,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_798 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_447);
      }
      ...
      {
         return new Rectangle(this.var_878 * this.maxScrollH,this.var_572 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_447);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_812,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1170));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1297 ? new PropertyStruct(PropertyDefaults.const_685,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1163) : PropertyDefaults.const_1814);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_284,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1257 ? new PropertyStruct(PropertyDefaults.const_1209,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1203) : PropertyDefaults.const_1650);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_905) ? new PropertyStruct(PropertyDefaults.const_395,this._field.textColor,PropertyStruct.const_138,true) : PropertyDefaults.const_1126);
         _loc1_.push(this.var_447 != TextStyleManager.const_197 ? new PropertyStruct(PropertyDefaults.const_405,this.var_447,PropertyStruct.const_52,true,PropertyDefaults.const_755) : PropertyDefaults.const_1210);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_929 ? new PropertyStruct(PropertyDefaults.const_260,this.var_41.left,PropertyStruct.const_41,true) : PropertyDefaults.const_689);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_850 ? new PropertyStruct(PropertyDefaults.const_258,this.var_41.top,PropertyStruct.const_41,true) : PropertyDefaults.const_831);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_771 ? new PropertyStruct(PropertyDefaults.const_278,this.var_41.right,PropertyStruct.const_41,true) : PropertyDefaults.const_732);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_924 ? new PropertyStruct(PropertyDefaults.const_253,this.var_41.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_708);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1130 ? new PropertyStruct(PropertyDefaults.const_946,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1663);
