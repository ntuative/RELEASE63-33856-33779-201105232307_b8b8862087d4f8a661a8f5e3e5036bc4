package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1622:uint = 500;
      
      protected var var_1349:String = "";
      
      protected var var_1353:Boolean = false;
      
      protected var var_709:Boolean = false;
      ...
      {
         this.var_1349 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1303,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_709 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_207,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_423,e);
         }
      }
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_106,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_955,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1830);
         _loc1_.push(this.var_1353 != PropertyDefaults.const_1135 ? new PropertyStruct(PropertyDefaults.const_784,this.var_1353,PropertyStruct.const_38,true) : PropertyDefaults.const_1616);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1242 ? new PropertyStruct(PropertyDefaults.const_723,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1625);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1254 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1715);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_784:
                  this.var_1353 = _loc2_.value as Boolean;
                  if(this.var_1353)
                  {
               ...
               case PropertyDefaults.const_723:
                  ...
                  break;
               case PropertyDefaults.const_955:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1114:
