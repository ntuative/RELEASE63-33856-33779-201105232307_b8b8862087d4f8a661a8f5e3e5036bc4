package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_197:String = "regular";
      
      public static const ITALIC:String = "italic";
      
      public static const BOLD:String = "bold";
      
      private static var var_90:Map;
      ...
      private static const const_671:String = "}";
      ...
      {
         return var_90.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_90.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_90[param1] = param2;
         if(_loc3_)
         {
            var_549.push(param1);
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_90[const_197],var_90[ITALIC],var_90[BOLD]];
            var_90.reset();
            var_90[const_197] = _loc5_[0];
            var_90[ITALIC] = _loc5_[1];
            var_90[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_90[_loc4_.name] = _loc4_;
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_90.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_671);
         if(countSubStrings(param1,const_670) != countSubStrings(param1,const_671))
         {
            throw new Error("Mismatching amount of \"" + const_670 + "\" versus \"" + const_671 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1526) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1527) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_670)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
