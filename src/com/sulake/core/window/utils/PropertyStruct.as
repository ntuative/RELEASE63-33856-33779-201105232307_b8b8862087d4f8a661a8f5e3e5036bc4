package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_190 = param2;
         this._type = param3;
         this.var_2716 = param4;
         this.var_2971 = param3 == const_243 || param3 == const_165 || param3 == const_236 || param3 == const_254;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_38:
               return Boolean(this.var_190) == true ? "true" : "false";
            case const_236:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_243:
               ...
               _loc1_ = "<var key=\"" + this.var_662 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_254:
               ...
               break;
            case const_138:
               _loc1_ = "<var key=\"" + this.var_662 + "\" value=\"" + "0x" + uint(this.var_190).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_662 + "\" value=\"" + this.var_190 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
