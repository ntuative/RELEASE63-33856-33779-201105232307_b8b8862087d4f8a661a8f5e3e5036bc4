package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_338 = new Array();
            var_338[0] = MouseCursorType.const_359;
            var_338[1] = MouseCursorType.const_30;
            var_338[2] = MouseCursorType.const_359;
            var_338[3] = MouseCursorType.const_359;
            var_338[4] = MouseCursorType.const_359;
            var_338[5] = MouseCursorType.const_30;
            var_338[6] = MouseCursorType.const_359;
         }
         if(var_289 == null)
         {
            var_289 = new Array();
            var_289[0] = WindowState.const_87;
            var_289[1] = WindowState.const_88;
            var_289[2] = WindowState.const_85;
            var_289[3] = WindowState.const_71;
            var_289[4] = WindowState.const_56;
            var_289[5] = WindowState.const_97;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_212;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_64 = state.var_1342 as WindowController;
         this.var_176 = state.var_1341 as WindowController;
         this.var_165 = state.renderer;
         this.var_873 = state.var_1340;
         eventQueue.begin();
         this.var_698.x = -1;
         this.var_698.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_698.x || event.stageY != this.var_698.y)
            {
               ...
               array = new Array();
               this.var_85.groupParameterFilteredChildrenUnderPoint(this.var_698,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_64.getGlobalPosition(var_409);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_64 && !this.var_64.disposed)
                     {
                        ...
                        {
                           this.var_873.mouseEventReceived(event.type,this.var_64);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1342 = this.var_64;
         state.var_1341 = this.var_176;
         state.renderer = this.var_165;
         state.var_1340 = this.var_873;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_508))
         {
