package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2054:String = "_INCLUDE";
      
      public static const const_1997:String = "_TEMP";
      
      private static const const_1568:String = "layout";
      
      private static const const_1091:String = "window";
      
      private static const const_1090:String = "variables";
      
      private static const const_1089:String = "filters";
      
      private static const const_450:String = "name";
      
      private static const const_1560:String = "style";
      
      private static const const_677:String = "params";
      
      private static const const_1559:String = "tags";
      ...
      private static const const_1562:String = "visible";
      
      private static const const_1566:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1326:String = "blend";
      
      private static const const_1563:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1571:String = "treshold";
      
      private static const const_1570:String = "children";
      
      private static const const_1567:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1558:String = "height_min";
      
      private static const const_1565:String = "height_max";
      
      private static const const_676:String = "true";
      
      private static const const_170:String = "0";
      
      private static const const_1569:String = "$";
      
      private static const const_1492:String = ",";
      
      private static const const_51:String = "";
      
      private static const const_1564:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1561:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1360:Dictionary;
      
      protected var var_1361:Dictionary;
      
      protected var var_1096:Dictionary;
      
      protected var var_1631:Dictionary;
      
      protected var var_2168:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1361 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1360,this.var_1361);
         this.var_1096 = new Dictionary();
         this.var_1631 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1096,this.var_1631);
         this.var_2168 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1561,const_51);
         return param1.replace(const_1564,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1360)
            {
               delete this.var_1360[_loc1_];
            }
            for(_loc1_ in this.var_1361)
            {
               delete this.var_1361[_loc1_];
            }
            for(_loc1_ in this.var_1096)
            {
               delete this.var_1096[_loc1_];
            }
            for(_loc1_ in this.var_1631)
            {
               delete this.var_1631[_loc1_];
            }
            this.var_2168.dispose();
            this.var_2168 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1568)
         {
            _loc8_ = param1.child(const_1090);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1089).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1091);
         ...
         if(param1.localName() == const_1091)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1360[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_450,variables,"")));
         style = uint(this.parseAttribute(xml,const_1560,variables,style));
         params = uint(this.parseAttribute(xml,const_677,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1559,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_170));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_170));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_170));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_170));
         visible = this.parseAttribute(xml,const_1562,variables,visible.toString()) == const_676;
         ...
         if(xml.child(const_677).length() > 0)
         {
            ...
            while(i < length)
            {
               ...
               if(this.var_1096[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_450)) + "\"!");
               }
               params |= this.var_1096[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1566,variables,caption)));
         if(tag != const_51)
         {
            tags = tag.split(const_1492);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1090)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1567,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1558,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1565,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_676;
         blend = Number(this.parseAttribute(xml,const_1326,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1563,variables,window.clipping.toString()) == const_676;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1571,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1089).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_190)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1361[param1.type];
