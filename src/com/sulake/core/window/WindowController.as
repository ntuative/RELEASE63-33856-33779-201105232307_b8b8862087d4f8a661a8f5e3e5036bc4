package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1097:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1338:String = "_COLORIZE";
      
      protected static const const_1339:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_992:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_406 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_62 = var_406.clone();
            var_11 = var_406.clone();
         ...
         if(_loc13_)
         {
            ...
            var_483 = _loc13_.var_2919;
            if(var_482 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_242 != _loc13_.color)
            {
      ...
      {
         return this.var_697 != null ? this.var_697 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_482 = param1;
         var_242 = !!var_482 ? uint(var_242 | var_570) : uint(var_242 & 16777215);
      ...
      {
         var_570 = param1 & 4278190080;
         var_242 = !!var_482 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      {
         var_570 = param1 << 24;
         var_242 = !!var_482 ? uint(var_570 | var_242) : uint(16777215 & var_242);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1326);
      }
      ...
      {
         var_483 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_733);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_82)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1339) == -1)
               {
                  _loc4_.style = var_82;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_342 = this._parent.rectangle.clone();
               var_62.x = var_11.x;
               var_62.y = var_11.y;
            ...
            else
            {
               this.var_342.x = 0;
               this.var_342.y = 0;
               this.var_342.width = 0;
               this.var_342.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1769,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_979,var_11);
            this.var_22.visible = var_320;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_82,var_21,_context,var_11,null,this.var_697,this.properties,var_877.concat(),_id) as WindowController;
         _loc2_.var_483 = var_483;
         _loc2_.var_175 = this.var_175;
         _loc2_._debug = this._debug;
         _loc2_.var_342 = this.var_342.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_406 = var_406.clone();
         ...
         _loc2_.var_242 = var_242;
         _loc2_.var_570 = var_570;
         _loc2_.var_704 = var_704;
         _loc2_.var_320 = var_320;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2175 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_494)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_538)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1106,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_407,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_944))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1178;
                  if(testParamFlag(WindowParam.const_377))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                  ...
                  if((var_21 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_337))
                        {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_40:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_807,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_190,WindowParam.const_185))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_218,WindowParam.const_176))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_555))
                        {
               ...
               case WindowEvent.const_407:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1141);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1856,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_194,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_499:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1158,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_310,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_507:
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
                  break;
               case WindowEvent.const_807:
                  this._parent.getRegionProperties(null,this.var_342);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_483);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_483);
      }
         ...
         if(this.var_175 && var_483 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_992,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_992,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_82 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1339) == -1)
               {
                  _loc6_.style = var_82;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_153,WindowParam.const_176);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_342.width;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_433)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_409)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_190)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_342.height;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_311)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_261)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1878,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_71,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1902,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1632,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1806,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_525,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1832,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_882,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_710,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_242,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1915,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1890,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1667,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1098 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_338,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1098 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_338,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
