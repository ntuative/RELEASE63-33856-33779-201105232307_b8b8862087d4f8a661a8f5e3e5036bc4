package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         var _loc4_:LocalizationDefinition = this.var_914[param1];
         if(_loc4_ == null)
         {
      ...
      {
         var _loc2_:LocalizationDefinition = this.var_914[param1];
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_914[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2252);
      }
      ...
      public function loadLocalizationFromURL(param1:String) : void
      {
         ...
         _loc4_.addEventListener(AssetLoaderEvent.const_50,this.onLocalizationFailed);
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_186));
         }
      }
      ...
      public function updateKey(param1:String, param2:String) : void
      {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1696);
         }
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_63)
         {
            ...
            {
               _loc2_.registerParameter("predefined",this.var_1696);
            }
         }
      }
   }
