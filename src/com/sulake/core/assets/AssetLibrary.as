package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1188:String = "AssetLibraryReady";
      
      public static const const_925:String = "AssetLibraryLoaded";
      
      public static const const_1909:String = "AssetLibraryUnloaded";
      
      public static const const_1781:String = "AssetLibraryLoadError";
      
      private static const const_450:String = "name";
      
      private static const const_1060:String = "asset";
      
      private static const const_1059:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1058:String = "library";
      
      private static var var_314:Dictionary;
      
      private static var var_1930:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_536 = new Dictionary(false);
         this.var_1019 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_654 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1058);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1060);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1059);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_654 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_654 == param1.url && this.var_1020)
         {
            if(!this.var_1017 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_655);
            }
            this.var_1017 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1188));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1019)
         {
            delete this.var_1019[_loc1_];
         }
         if(this.var_43 != null)
         {
            this.var_43.dispose();
         ...
         this.var_1020 = false;
         this.var_654 = null;
         dispatchEvent(new Event(AssetLibrary.const_1909));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1019[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_536[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_50,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1334,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1160,this.assetLoadEventHandler);
         ...
         this.var_536[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_536[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_536[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_166[param1] != null || (this.var_655 != null ? this.var_655[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1930.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_314.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_314[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_314[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_314)
            {
               _loc3_ = AssetTypeDeclaration(var_314[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_314)
            {
               _loc4_ = AssetTypeDeclaration(var_314[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_655 = _loc2_.resource;
         this.var_654 = _loc2_.url;
         if(this.var_1017)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_655);
         }
         this.var_1020 = true;
         dispatchEvent(new Event(AssetLibrary.const_925));
         dispatchEvent(new Event(AssetLibrary.const_1188));
         if(this.var_1017)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1781));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1058);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1060);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_450).toString() == param1)
               {
                  ...
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_654 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_655[param1]);
                  _loc6_ = _loc3_.child(const_1059);
                  if(_loc6_.length())
                  {
