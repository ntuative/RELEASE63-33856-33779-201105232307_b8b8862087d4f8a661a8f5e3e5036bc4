package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_445:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2179:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1211:uint = 4;
       
      
      protected var var_813:uint = 0;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1347 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1347);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1596 & const_1211)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_912 = false;
            this._events.dispatchEvent(new LockEvent(const_445,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_813 + "]";
      }
