package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_1022 = param1 * 1024 * 1024;
         this.var_1944 = param2 * 1024 * 1024;
         this.var_1538 = param3 * 1024 * 1024;
         if(this.var_1538 < 0)
         {
            this.var_1538 = 0;
         }
      ...
      {
         this.var_1022 += this.var_1538;
         if(this.var_1022 > this.var_1944)
         {
            this.var_1022 = this.var_1944;
         }
      }
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_800 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_800 += param2.width * param2.height * 4;
      }
   }
}
