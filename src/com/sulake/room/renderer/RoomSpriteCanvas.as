package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1489:int = 50;
      
      private static const const_1057:Number = 60;
      
      private static const const_1490:Number = 50;
      ...
      private var var_1519:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2651:Number = -1.0E7;
      
      private var var_2650:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_267 = new Sprite();
         this.var_267.mouseEnabled = false;
         this.var_104 = new Sprite();
         this.var_104.name = "canvas";
         this.var_104.mouseEnabled = false;
         this.var_267.addChild(this.var_104);
         ...
         this.var_266 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
      ...
      {
         this.var_532.x -= param1 - this.var_641;
         this.var_641 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_532.y -= param1 - this.var_640;
         this.var_640 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_917 = true;
            if(this.var_145 != null && !this.var_267.contains(this.var_145))
            {
               this.var_267.addChild(this.var_145);
               this.var_104.mask = this.var_145;
            }
         }
         else if(!param1 && this.var_917)
         {
            this.var_917 = false;
            if(this.var_145 != null && this.var_267.contains(this.var_145))
            {
               this.var_267.removeChild(this.var_145);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_267.numChildren > 0)
            {
               this.var_267.removeChildAt(0);
            }
            this.var_267 = null;
         }
         this.var_104 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_643.length)
            {
               this.cleanSprite(this.var_643[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_643 = [];
         }
      ...
      {
         this.var_1915 = !this.var_1915;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1520)
         {
            return;
         }
         ...
         if(this.var_533 != this.var_2654 || this.var_530 != this.var_2652)
         {
            _loc8_ = true;
         }
         if(this.var_104.x != this.var_641 || this.var_104.y != this.var_640)
         {
            this.var_104.x = this.var_641;
            this.var_104.y = this.var_640;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_531.sortOn("z",0 | 0);
         if(_loc5_ < this.var_531.length)
         {
            this.var_531.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_531[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2654 = this.var_533;
         this.var_2652 = this.var_530;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1520 > 0)
         {
            _loc2_ = param1 - this.var_1520;
            if(_loc2_ > const_1057 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2655 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_795;
               if(this.var_795 == const_367 + 1)
               {
                  this.var_516 = _loc2_;
                  this.var_1914 = this.var_2656;
               }
               else if(this.var_795 > const_367 + 1)
               {
                  _loc3_ = Number(this.var_795 - const_367);
                  this.var_516 = this.var_516 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1914 = this.var_1914 * (_loc3_ - 1) / _loc3_ + Number(this.var_2656) / _loc3_;
                  if(this.var_795 > const_367 + const_1489)
                  {
                     this.var_795 = const_367;
                     if(!this.var_1266 && this.var_516 > const_1057)
                     {
                        this.var_1266 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1266 && this.var_516 < const_1490)
                     {
                        this.var_1266 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1915 && this.var_1266);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_641;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_640;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_531.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_641;
                     _loc17_.y = _loc20_ - this.var_640;
      ...
      {
         if(param1 < this.var_533 && param1 + param3 >= 0 && (param2 < this.var_530 && param2 + param4 >= 0))
         {
            if(!this.var_2968)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param2 + param4 >= this.var_530)
         {
            param4 -= this.var_530 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2653)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1015)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_643.length > 0)
         {
            _loc3_ = this.var_643.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1015)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_794 || this.var_794 == 0)
         {
            _loc4_ = this.var_1015 - 1;
            while(_loc4_ >= param1)
            {
      ...
      {
         if(param1 < 0 || param1 >= this.var_531.length)
         {
            return null;
         }
         return this.var_531[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_266.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_266.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_753.redMultiplier = tR;
            this.var_753.greenMultiplier = tG;
            this.var_753.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_753);
            if(name.length > 0)
            {
               this.var_266.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_641;
         param2 -= this.var_640;
         this.var_532.x = param1;
         this.var_532.y = param2;
         if(this.var_1265 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1916;
         }
         this.var_1916 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1265;
         return this.var_1916;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_530 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1917,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_645.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_645.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2651 || param2 != this.var_2650)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_645.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_645.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_381.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1519.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1265 == 0)
         {
            this.checkMouseHits(this.var_532.x,this.var_532.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1265 = 0;
         ++this.var_1917;
      }
