package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_393:IRoomObjectController;
      ...
      {
         if(this.var_393 == param1)
         {
            return;
         }
         if(this.var_393 != null)
         {
            this.var_393.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_393 = param1;
            this.var_393.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_393 != null)
            {
               this.var_393.setLocation(param1.loc);
               this.var_393.setDirection(param1.dir);
            }
         }
      }
