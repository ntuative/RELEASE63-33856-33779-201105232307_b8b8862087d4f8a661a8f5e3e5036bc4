package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         this.var_156 = new ByteArray();
         this.var_113 = 0;
         while(this.var_113 < this.psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = this.var_113++;
            this.var_156[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            this.var_156[_loc4_ = this.var_113++] = _loc2_ & 255;
         }
         this.var_113 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = this.var_113++;
         this.var_156[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_113++;
         this.var_156[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_156[_loc4_ = this.var_113++] = this.var_156[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_156[_loc5_ = this.var_113++] = this.var_156[_loc5_] ^ param1 >> 24 & 255;
         this.var_113 %= this.psize;
         this.var_2264 = true;
      }
      ...
      public function nextByte() : int
      {
         if(!this.ready)
         {
            ...
            this.state.init(this.var_156);
            this.var_156.length = 0;
            this.var_113 = 0;
            this.ready = true;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_156[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         this.var_156.length = 0;
         this.var_156 = null;
