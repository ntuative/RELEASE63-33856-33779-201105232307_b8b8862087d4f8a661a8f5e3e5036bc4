package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1886 = param1.invDigit();
         this.var_1885 = this.var_1886 & 32767;
         this.var_2591 = this.var_1886 >> 15;
         this.var_2590 = 131071;
         this.var_2589 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_170) > 0)
         {
